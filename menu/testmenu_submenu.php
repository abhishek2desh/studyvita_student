					...
					if($row_sub[0]=="Buy Study Material")
										...
										$result_t=mysql_query("SELECT menu_name,menu_web_link FROM `text_book_link` WHERE board_id='$br_id' AND std_id='$std_id' AND subject_id IN(SELECT DISTINCT sub_id FROM subject_alias WHERE rel_sub_id='$subject_id')");
											...
											if($rw_t>0)
											{
												...
												{
												echo "<li><a href='$row_t[1]' >$row_t[0]</a></li>";
												}
													echo "</ul>";
												echo "</li>";
											}
										...
										while($row_link2=mysql_fetch_array($result_link2))
												{
													if($row_link2[4]==="")
													{
													echo "<li><a href='$row_link2[2]' >$row_link2[0]</a></li>";
													}
													else
													{
													echo "<li><a href='$row_link2[2]' >$row_link2[4]</a></li>";
													}
...
AND  '$formatDate' BETWEEN cv.from_date AND cv.to_date and mm.pathfilename IS NOT NULL");
								...
								$result_t=mysql_query("SELECT menu_web_link FROM `text_book_link_chapterwise` WHERE chapter_id='$row_link3[0]'");
											...
											if($rw_t>0)
											{
												...
												while($row_t=mysql_fetch_array($result_t))
												{
												echo "<li><a href='$row_t[0]' >NCERT TextBook</a></li>";
												}
							...
							echo "<ul>
									...
									<li><a href='test-paper-generator-unitwise.php' >Unitwise Test</a></li>
								</ul>";
							...
							{
								echo "<ul>
									<li><a href='test_paper_generator_request.php'>Request Test</a></li>
									<li><a href='insrtuction_part_request.php' >Take Test</a></li>
									<li><a href='view_my_mistakes_request.php' >View My Mistakes</a></li>
									<li><a href='view_my_result_request.php' >View Result</a></li>
										</ul>";
							}
								else if($row_sub[0] == "Test on Demand"  && $row_in[2]=='10')
							{
							...
							{
								echo "<ul>
									<li><a href='comp-state.php' >State wise</a></li>
									<li><a href='comp-national.php' >National</a></li>
									<li><a href='comp-international.php' >International</a></li>
								</ul>";
							}
							else if($row_sub[0] == "Webinar")
							{
								echo "<ul>
									<li><a href='webinar-class.php' >Academic</a></li>
									<li><a href='webinar-class.php' >Motivational</a></li>
									<li><a href='webinar-class.php' >Studyvita Training</a></li>
							...
							else if($row_sub[0] == "Knowledge meter")
							{
								echo "<ul>
									...
									<li><a href='PerformanceAnalysis.php' >Performance Analysis</a></li>
								</ul>";
							}
