...
<tr>
<td style='width:90%;border:solid 0px;'>
<center>
<nav>
	<ul>
	<?php
			...
			while($row_in=mysql_fetch_array($result_in))
			{
				echo "<li><a href='$row_in[1]'>$row_in[0]</a>";
					...
					if($row_sub[0]=="Buy Study Material")
										...
										echo "<li><a href=http://www.coreacademics.in/edushopee/index.php?uid=".$s5."&uname=".$u5.">$row_sub[0]</a>";
										}
										...
										{
										echo "<li><a href=http://www.coreacademics.in/pricing/index.php?uid=".$s5."&uname=".$u5.">$row_sub[0]</a>";
										}
							...
							/*virtual-class.php?course_id=" + course_id + "&batch_id=" + batch_id + "&subject_id=" + subject_id + "&uid=" + uid + "&name=" + username_temp + "&domainname=" + domainname1 + "&vl=1"*/
								echo "<li><a href=http://student.coreacademics.in/virtual-class.php?course_id=".$course_id."&batch_id=".$batch_id."&subject_id=".$subject_id."&uid=".$s5."&name=".$u5."&domainname=".$domaimname1."&vl=".$v1.">$row_sub[0]</a>";
							}
...
AND  '$formatDate' BETWEEN cv.from_date AND cv.to_date and mm.pathfilename IS NOT NULL");
							...
							{
							echo "<ul>
									<li><a href='test_paper_generator_chapterwise.php' target='_blank'>Chapterwise Test</a></li>
									<li><a href='test_paper_generator_custom.php' target='_blank'>Customized Test</a></li>
							...
							echo "<li><a href=http://www.coreacademics.in/edushopee/index.php?uid=".$s5."&uname=".$u5.">$row_sub[0]</a>";
								...
								echo "<ul>
								<li><a href=http://www.coreacademics.in/edushopee/index.php?uid=".$s5."&uname=".$u5.">Buy Study Material</a>
...
<td style='width:10%;border:solid 0px;' align="right">
	<!--<button class="button">
	<?php
