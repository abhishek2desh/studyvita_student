<?php
	include 'config.php';
	session_start();
	$stud_id=$_SESSION['sid']='9352';
	$s5=$_SESSION['sid']='9352';
	$u5 = $_SESSION['uname']='Beena12';
	$course_id=$_SESSION['course_id']='13';
	$batch_id=$_SESSION['batch_id']='186';
	$domaimname1=$_SESSION['domain_name']='coreacademics.in';
	//echo $batch_id;
	$subject_id=$_SESSION['subject_id']='14';
