			...
			<table style="border-radius: 5px;width:100%;height:535px;background: purple;">
				<tr>
					...
					<td valign="top" style="border-radius: 10px;width:69.9%;height:488px;background: #EEEEEE;">
						...
						<div>
							<input type="BUTTON" class="defaultbutton" id="sub_phy" name="select_question" value="physics"/>
							<input type="BUTTON" class="defaultbutton" id="sub_bio" style="width:80px;" name="next" value="biology"/>
							<input type="BUTTON" class="defaultbutton" id="sub_che" name="select_question" value="chemistry"/>
							<input type="BUTTON" class="defaultbutton" id="sub_mat" name="select_question" value="maths"/>
							<input type="BUTTON" class="defaultbutton" id="sub_eng" name="select_question" value="english"/>
							<input type="BUTTON" class="defaultbutton" id="sub_sce" name="select_question" value="science"/>
							<input type="BUTTON" class="defaultbutton" id="sub_ss" name="select_question" value="social study"/>
							...
							<tr>
								<td valign="top" style="border-radius: 5px;width:100%;height:70px;background: #EEEEEE;">
									<table style="border-radius: 5px;width:100%;height:30px;background: #EEEEEE;">
										<tr>
											<td>
												Answer &nbsp;<input type="button" class="myButton" style="border-radius: 5px;background-color:green;" width="30px;" value="">
											</td>
											<td>
												Not Answer &nbsp;<input type="button" class="myButton" style="border-radius: 5px;background-color:red;" width="30px;" value="">
											</td>
											<td>
												Review &nbsp;<input type="button" class="myButton" style="border-radius: 5px;background-color:yellow;" width="30px;" value="">
											</td>
										</tr>
									</table>
									<table style="border-radius: 5px;width:100%;height:40px;background: #EEEEEE;">
										...
										<tr>
											...
											<td>
												<input type="button" id="final_test" class="defaultbutton" style="border-radius: 5px;background-color:grey;" width="100px;" value="Final Submit">
											</td>
										</tr>
