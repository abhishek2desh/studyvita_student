...
<html lang="en">
    <head>
		...
		<style>	
			...
			body {
				background: #34495e url(images/1212.jpg) no-repeat center top;
...
$(".loading-gif").hide();
				...
				$('#start_test').click(function(){
					...
					else
					{
						...
						/*filename = "query/check-demo-customtest1.php?course_id="+course_id+"&batch_id="+batch_id+"&uid="+uid;
						//alert(filename);
						$.ajax({
						url: filename,
						type: 'GET',
			...
			<table style="padding-top:0px;border:solid 0px;width:100%;height:25px;">
				<tr>
					...
					<?php
												...
												$subname=$row_c1[0];
												echo "<label style='float:left;color:#ffffff;'><font face='verdana' size='3' color='white' ><b>".$crname.">".$subname.">"."Custom Test </b></font></label>";
