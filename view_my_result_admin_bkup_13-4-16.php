...
//alert(filename);
			...
			$("#shadow").fadeIn("normal");
				...
				filename = "test_paper_generator/20_get_test_id3.php?sub_id="+sb11+"&uid="+uid;
				//alert(filename);
				getContent(filename, "test_id");
				filename = "30_view_student_test_result3.php?uid="+uid+"&sb_result="+sb11+"&cp_result="+cp_result+"&std_result="+std_result;
				//alert(filename);
				...
				$( "#datepicker44" ).datepicker({
					...
					onSelect: function() { 
						...
						filename = "test_paper_generator/20_get_test_id3.php?sub_id="+sb11+"&uid="+uid+"&dt1="+datepickerVal44+"&dt2="+datepickerVal45;
						//alert(filename);
						getContent(filename, "test_id");
				...
				$('#cp_list').change(function(){
					...
					filename = "30_view_student_test_result3.php?uid="+uid+"&sb_result="+sb_result+"&cp_result="+cp_result+"&std_result="+std_result;
					//alert(filename);
					getContent_hide(filename, "view_result_of_adaptive_test_student");
				});
			});
			...
			<table style="padding-top:0px;border:solid 0px;width:100%;height:25px;">
				<tr>
					...
					<?php
												...
												$subname=$row_c1[0];
												echo "<label style='float:left;color:#ffffff;'><font face='verdana' size='2' color='white' ><b>".$tutorname.">".$crname.">".$subname.">"."View Result</b></font></label>";
						...
						<div style="background-color:#3366FF;border:solid 0px;width:100%;height:25px;">
							<table style='width:100%'>
								<tr>
									...
									<td style="width:100px;background-color:#3366FF;border:solid 1px;height:20px;"><center><label style="color:white"><b>Diagnostic Report</b></label></center></td>
								</tr>
							</table>
						</div>
...
<br/>
			...
			<input type='button' class='defaultbutton' id='analysis_ch' value='Chapterwise Analysis' />
				...
				<input type='button' class='defaultbutton'  value='View My Mistakes' onclick="window.location.href='view_my_mistakes_admin.php'"/>
			</td>
			</tr>
			</table>
				<table style="width:100%;">
