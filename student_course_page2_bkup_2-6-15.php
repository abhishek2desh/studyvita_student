...
var blink = function() {
		  ...
		  var course_total_fees=0;
				...
				$("#course_id").change(function(){
					...
					getContent_batch(filename, "batch_id");
					 //$('select[name=batch_id_new] option:eq(0)').attr('selected', 'selected');
					   //$("#batch_id").val($("#batch_id option:eq(1)").val());
						//$("#batch_id option[value='3']").attr("selected", "selected");
				});
  ...
  padding-bottom: 15px;'>
			...
			<center><div style="background-color: #333399;  width: 56%;  padding: 10px;" >
  ...
  padding-bottom: 15px;'>
				<center>
			<div style='padding-top:0px;background:#333399;width:84%;height:200px;;  background: rgb(87, 81, 81);'>
					<table style='width:100%;height:40px;'>
						<tr>
							<td style='background:#333399 ;width:100%;'>
			...
			<center><div style="padding-top:90px" ><section><button id="btn-click" class="btn btn-7 btn-7a icon-truck defaultbutton">Proceed to Checkout</button>
	</section>
</div></center>
