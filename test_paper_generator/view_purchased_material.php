<?php
	...
	else
	{
		...
		$j++;
			...
			if($row[5]=="Schoolpaper" || $row[5]=="SchoolPaper")
			{
			$fmn_qus=$row[1]."_Ans";
			}
			else
			...
			*/
				echo "<td style='color:black;border:solid 0px;'><center><input type='radio' name='name_ts' id='$row[2]|$row[0]|$row[1]|$row[3]|$ans|$srno_ans|$row[4]|$row[5]|$srno_ans_name|$que_path' class='ck' value='$row[0]' /></center></td>";
