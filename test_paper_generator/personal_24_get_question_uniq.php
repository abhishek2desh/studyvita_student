<?php
		...
		$result=mysql_query("SELECT distinct test_id,Qno,Uniq_id,response,correct_ans FROM `personalassignment_response` WHERE test_id='$test_id' AND user_id='$uid' AND assignment_id='$assignment_id'");
