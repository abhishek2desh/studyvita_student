<?php
	...
	*/
	...
	$insert_test=mysql_query("INSERT INTO adaptive_learning_test(`test_id`,`student_id`,`SUBJECT`,`noq`,`start_time`,`end_time`,`total_time`,`test_type`,`chapter_id`,`batch_id`,chapterwise_test)VALUES('$max_id_test','$user_id','$sub','$req_que','$start_time','$end_time','$t_t','$type','$cp_value12','$batch_id','$chtest')");
