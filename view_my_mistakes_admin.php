...
<head>		
		...
		var page_source="view_my_mistakes_admin.php";
...
filename = "query/update_submenu_log.php?uid="+uid+"&docid="+currentdocid+"&start_time="+doc_start_time+"&end_time="+doc_end_time+"&page_source="+page_source+"&submenu_with_menu="+submenu_with_menu+"&sub_menu_name="+sub_menu_name;
			...
			filename = "test_paper_generator/20_get_test_id3.php?sub_id="+sb11+"&uid="+uid+"&test_type="+test_type;
				//alert(filename);
			...
			filename = "test_paper_generator/20_get_test_id3.php?sub_id="+sb11+"&uid="+uid+"&test_type="+test_type;
				...
				$( "#datepicker44" ).datepicker({
					...
					onSelect: function() { 
						...
						//alert(datepickerVal44);
							sb11=$("#sub_id_select").val();
						filename = "test_paper_generator/20_get_test_id3.php?sub_id="+sb11+"&uid="+uid+"&dt1="+datepickerVal44+"&dt2="+datepickerVal45+"&test_type="+test_type;
						//alert(filename);
						getContent(filename, "test_id");
							$("#view_que_sel_1").html("");
					}
				...
				$('input[type="radio"][name="checked_choice"]').click(function(){
					...
					//alert(filename);
					getContent_que(filename, "view_que_sel_1");
						}
					}
...
<!-- Animation Content Div -->
	...
	<div style='background-color:#fff;width:100%'>
		...
		?>
			...
			<center><table class="main_div2" style="border:solid 0px;width:80%;height:25px;">
				<tr>
		...
		foreach($lst as $item) 
		{
			...
			?>
								...
								<td>
									<select id="test_type" name="test_type" style="background-color:;width:160px;">
									<option value='0'>Select TestType</option>
									<option value='1'>Adaptive Test</option>
									<option value='2'>Scheduled Test</option>
									</select>
								</td>
								<td>
								...
								<td>
									<!--<input type="BUTTON" id="view_dg_report" class="defaultbutton" name="view_dg_report" value="Diagnostic Report"/>-->
								</td>
							</tr>
						</table>
					</td>
							...
							<tr>
								<td style='float:right;'>
									<table>
										<tr>
											<!--<td>
												<input type="BUTTON" id="view_my_mistakes_bt" class="defaultbutton" name="next" value="View My Mistakes"/>
											</td>-->
											<td>
												<input type="BUTTON" id="s_prv" class="defaultbutton" name="s_prv" value="Previous"/>
											</td>
											<td>
												<input type="BUTTON" id="s_nxt" class="defaultbutton" name="s_nxt" value="Next"/>
											</td>
										</tr>
									</table>
								</td>
