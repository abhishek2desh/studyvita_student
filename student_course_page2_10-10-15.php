...
var blink = function() {
  ...
  padding-bottom: 15px;'>
						...
						<br/>
						<div id="course_id" style="border:solid 1px;width:700px;height:150px;overflow-y:scroll;">
					...
					echo "</tr>";
						...
						<table id="2tablt"  style='border:solid 0px;width:100%;height:70px;  background: url(images/bg-white-lock.png) repeat;
  width: 360px;
  margin: 0 auto;
  margin-bottom: 0px;
  padding: 30px;
  ...
  padding-bottom: 15px;'>
			...
			<table style='border:solid 0px;width:100%;'>
						<tr>
								...
								<td>
								<div class="form-4"  >
								<input class="defaultbutton" type="submit" name="submit" value="Continue" id='log-submit'>
								</div>
								</td>
							</tr>
				</table>
	...
	<button class="btn btn-3 btn-3e defaultbutton" onclick="location.href='#'" id='reg_new_course' >Buy/View New Courses</button>		
			...
			<center><div style="background-color: #FF9009;  width: 48%%;" >
