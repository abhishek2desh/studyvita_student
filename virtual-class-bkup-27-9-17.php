...
<script type="text/javascript" language="javascript">
    ...
    function checklist(ctrl)
    {
        ...
        {
            list[i].style.background = '#4d90c9';
        }
...
chapter_id=$("#text_chapter").val();
	...
	{
var url="http://student.coreacademics.in/view-studyvita-video.php";
	...
	$('#descq_id').click(function(){
					...
					var url="http://student.coreacademics.in/desc-questions.php?qid="+qid+"&chapter_id="+chapter_id;
					//alert(url);
					window.open(url, '_blank');
					}
				//alert(qid);
...
filename = "query/update_document_log.php?uid="+uid+"&docid="+currentdocid+"&start_time="+doc_start_time+"&end_time="+doc_end_time+"&page_source="+page_source;
				...
				$('#ppt_id').click(function(){
					...
					{
					var url="http://student.coreacademics.in/view-ppt.php?document_name="+document_name;
					//alert(url);
					window.open(url, '_blank');
					}
...
filename1 = "query/insert_document_log.php?uid="+uid+"&docid="+currentdocid+"&start_time="+doc_start_time+"&page_source="+page_source;
				...
				$('#prt_id').click(function(){
					...
					document_name=mySplitResult[2];
					path=mySplitResult[0];
					var url="http://student.coreacademics.in/view-material.php?document_name="+document_name;
					//alert(url);
					window.open(url, '_blank');
						/*dnd=document_name;
						input = path;
					...
					$.ajax({
						...
						if(data == "")
							...
							else
							{
								...
								form_type='20';
								url="http://faculty.coreacademics.in/home.php?id="+id+"&name="+name+"&domainname="+domainname+"&menu_view=1&ct=1&form_type="+form_type;
								//alert(url);
								location.href=url;
							}
						},
...
filename1 = "query/insert_document_log.php?uid="+uid+"&docid="+currentdocid+"&start_time="+doc_start_time+"&page_source="+page_source;
					...
					path=mySplitResult[0];
					sb=mySplitResult[3];
					url="http://student.coreacademics.in/student_course_page_new1.php?vl=2&type=OA&mat_id="+document_name+"&path="+path;
...
filename1 = "query/insert_document_log.php?uid="+uid+"&docid="+currentdocid+"&start_time="+doc_start_time+"&page_source="+page_source;
				...
				$('#otp_id').click(function(){
					...
					path=mySplitResult[0];
					sb=mySplitResult[3];
					url="http://student.coreacademics.in/student_course_page_new1.php?vl=2&type=OQ&mat_id="+document_name+"&path="+path;
...
$uid=$s5;
	...
	if($flg==1)
	{
		echo "<marquee> <a href='insrtuction_part.php' target='_blank' ><font size='4'> Click Here</a> to start Learn n' Win contest</font></marquee><br/>";
			...
			<td style="width:100%;">
			<br/>
			<input id="144" type="radio" name="menu_view_type1"  value="144"/><label style='color:black' for="144"><b> Menu View </b></label>
								<input id="145" type="radio" name="menu_view_type1" value="145"  checked='true'/><label style='color:black' for="145"><b>Tile View</b></label>
  ...
  Your browser does not support the audio element.
			...
			<a href='test_paper_generator_custom.php' target='_blank' class='btn btn-sm style4 hover-blue' style="width:100px;color:white;background-color:#1b4268;"><font size='1' ><b>Diagnostic Test</b></font></a>
			<a href='test_paper_generator.php' target='_blank' class='btn btn-sm style4 hover-blue' style="width:100px;color:white;background-color:#1b4268;"><font size='1'><b>Adaptive Learning</b></font></a>
			<a href='competition-event.php' target='_blank' class='btn btn-sm style4 hover-blue' style="width:100px;color:white;background-color:#1b4268;"><font size='1'><b>Upcoming Events & Competition</b></font>
			
			</a>
			
			<?php
		
			echo "<a href=http://www.coreacademics.in/edushopee/index.php?uid=".$s5."&uname=".$u5." class='btn btn-sm style4 hover-blue' style='width:100px;color:white;background-color:#1b4268;'><font size='1'>";
			?><b>Edu-Shoppee</b></font></a>
			<a href='test_paper_generator_chapterwise.php' target='_blank' class='btn btn-sm style4 hover-blue' style="width:100px;color:white;background-color:#1b4268;"><font size='1'><b>Take Test</b></font>
			
			</a>
			<a href='view-studyvita-video.php' target='_blank' class='btn btn-sm style4 hover-blue' style="width:100px;color:white;background-color:#1b4268;"><font size='1'><b>Why Studyvita?</b></font>
			
			</a>
			<a href='#'  class='btn btn-sm style4 hover-blue' style="width:100px;color:white;background-color:#1b4268;" id="abcourse" ><font size='1'><b>About Courses</b></font>
			...
			$result=mysql_query("SELECT id,NAME FROM user WHERE id='$s5' and faculty_id is not null");
							...
							if($res>0)
							{
							echo "<a href='#' class='btn btn-sm style4 hover-blue' style='width:100px;color:white;background-color:#1b4268;' id='facultylive'><font size='1'><b>Go to Faculty Login</b></font></a>";
							}
			?>
			</center>
			</td>
			...
			<!--<tr>
			<td  style="width:25%;">
			<center><a href='test_paper_generator_custom.php' target='_blank' class='btn btn-sm style4 hover-blue' style="width:100px;color:red;"><font size='2.5'><b>Diagnostic Test</b></font></a>
			</td>
			<td  style="width:25%;">
			<center><a href='test_paper_generator.php' target='_blank' class='btn btn-sm style4 hover-blue' style="width:100px;color:red;"><font size='2.5'><b>Adaptive Learning</b></font></a>
			</td>
			<td  style="width:25%;">
			<a href='competition-event.php' target='_blank' class='btn btn-sm style4 hover-blue' style="width:100px;color:red;"><font size='2.5'><b>Upcoming Events & Competition</b></font>
			...
			echo "<a href=http://www.coreacademics.in/edushopee/index.php?uid=".$s5."&uname=".$u5." class='btn btn-sm style4 hover-blue' style='width:100px;color:red;'><font size='1'>";
			?><b>Edu-Shoppee</b></font></a>
			</td>
			</tr>-->
			</table></center>
			...
			<?php
												$result_c=mysql_query("SELECT c.name,u.name,c.course_icon,c.id FROM course c,user u WHERE c.id='$course_id' and u.id=c.tutor_id");
												$row_c=mysql_fetch_array($result_c);
												$crname=$row_c[0];
												$cr_icon=$row_c[2];
												echo "<b><i>".$crname."</i></b></br>";
												echo "<img src='$cr_icon' style='width:7em;max-height:7em'>";
												?>
			</td>--->
			<td style="width:100%;" valign="top">
			<font color="black"><table style="width:100%;border:solid 0px;">
...
while($row_unit=mysql_fetch_array($result_unit))
			...
			Take Test&nbsp;<div class="toggle-button" id="myP">        <button></button></div>
			
			&nbsp;&nbsp;About Courses&nbsp;<div class="toggle-button1" id="myP1">
              <button></button> </div>
			  &nbsp;&nbsp;Why Studyvita?&nbsp;<div class="toggle-button2" id="myP2">
              <button></button> </div>
			</td>-->
			</tr>
			</table>
			...
			<tr class="dtwise" >
					<td style="width:100%;padding-left:20px;">
						<div id="schedule_data" style="border:solid 1px;width:98%;height:320px;overflow-y:scroll;padding-left:0px;"></div>
					</td>
				</tr>
			</table></font>
...
?>
			...
			<center><font color="#1b4268" size="3"><i>Do not share your User name and Password with your Friends.
...
<center><table  style='width:98%;' class="matlist">
<tr>
...
<tr>
<td style='width:100%;' valign="top">
<div id="mat_click_view">
<div  id="ppt_id" name="ppt_id" style="border:solid 0px;background-color:white;width:100%;height:170px;font-size:14px;overflow-y: scroll;"></div>
<div  id="not_id" name="not_id" style="border:solid 0px;background-color:white;width:100%;height:170px;font-size:14px;overflow-y: scroll;"></div>
<div  id="vod_id" name="vod_id" style="border:solid 0px;background-color:white;width:100%;height:170px;font-size:14px;overflow-y: scroll;"></div>
<div  id="top_id" name="top_id" style="border:solid 0px;background-color:white;width:100%;height:170px;font-size:14px;overflow-y: scroll;"></div>
<div  id="das_id" name="das_id" style="border:solid 0px;background-color:white;width:100%;height:170px;font-size:14px;overflow-y: scroll;"></div>
<div  id="oas_id" name="oas_id" style="border:solid 0px;background-color:white;width:100%;height:170px;font-size:14px;overflow-y: scroll;"></div>
<div  id="dtp_id" name="dtp_id" style="border:solid 0px;background-color:white;width:100%;height:170px;font-size:14px;overflow-y: scroll;"></div>
<div  id="otp_id" name="otp_id" style="border:solid 0px;background-color:white;width:100%;height:170px;font-size:14px;overflow-y: scroll;"></div>
<div  id="weblink_id" name="weblink_id" style="border:solid 0px;background-color:white;width:100%;height:170px;font-size:14px;overflow-y: scroll;"></div>
<div  id="maz_id" name="maz_id" style="border:solid 0px;background-color:white;width:100%;height:170px;font-size:14px;overflow-y: scroll;"></div>
<div  id="descq_id" name="descq_id" style="border:solid 0px;background-color:white;width:100%;height:170px;font-size:14px;;overflow-y: scroll;"></div>
<div  id="prt_id" name="prt_id" style="border:solid 0px;background-color:white;width:100%;height:170px;font-size:14px;overflow-y: scroll;"></div>
</div>
</td>
</tr>
<tr>
...
<table style="width:100%;">
<tr>
<td style="width:30%;border:solid 1px;height:290px" valign="top">Notification</td>
<td style="width:70%;" valign="top">
<font size="1"><input type="button" class="defaultbutton" style="width:auto;color:white;background-color:#1b4268;" id="forth_schedule" value="ForthComing Exams">
<input type="button" class="defaultbutton" style="width:auto;color:white;background-color:#1b4268;" id="assinment_forthcoming" value="Forthcoming Assignment">
<input type="button" class="defaultbutton" style="width:auto;color:white;background-color:#1b4268;" id="assinment_pending" value="Pending Assignment">
<input type="button" class="defaultbutton" style="width:auto;color:white;background-color:#1b4268;" id="assinment_history" value="Assignment History">
	</font>		
	<br/>
	<br/>
	
<div id='test_schedule' style="border:solid 1px;width:100%;height:250px;overflow-y: scroll;">
								<?php
							...
							<div id='examination_schedule' style="border:solid 1px;width:100%;height:250px;overflow-y: scroll;">
								<?php
									...
									while($row=mysql_fetch_array($result))
									{
										...
										echo "<td style='border:solid 1px;'><center><input type='button' class='search1_asnt' id='search1_asnt' value='Submit Now' style='width:100%;'/></center></td>";
										echo "</tr>";
									}
									echo "</table>";
									...
									while($row=mysql_fetch_array($result1))
									{
										echo "<tr><td style='border:solid 1px;'><center>$row[0]</center></td><td style='border:solid 1px;'><center>$row[3]</center></td><td style='border:solid 1px;'><center>$row[1]</center></td><td style='border:solid 1px;'><center>$row[2]</center></td>";
											echo "<td style='border:solid 1px;'><center><input type='button' class='search2' id='search2' value='Start Now' style='width:100%;'/></center></td>";
										echo "</tr>";
									}
									echo "</table>";
	...
	<div id='Assignment_pendinglist' style="border:solid 1px;width:100%;height:250px;overflow-y: scroll;">
								<?php
...
(SELECT DISTINCT `material_id` FROM `student_upload_assignment` WHERE `user_id`='$s5')");
									while($row=mysql_fetch_array($result_sub))
									{
										...
										echo "<td style='border:solid 1px;'><center><input type='button' class='search_sub_t' id='search_sub_t' value='Submit Now' style='width:100%;'/></center></td>";
										echo "</tr>";
									}
	...
	<div id='Assignment_historylist' style="border:solid 1px;width:100%;height:250px;overflow-y: scroll;">
								<?php
		...
		<div id="form_material_subjective">
			...
			<table style="background-color:#2196F3;border:px solid;width:100%;height:30px;">
				...
				<td valign="top" style="border:0px solid;width:60%;">
					...
					<select class="inputs" id="text_mark" name="text_mark"></select>
				</td>
				</tr>
				</table>
