				...
				<tr>
					<td id='swf_hide' valign='top' style="border:solid 0px;width:80%;">
						...
						?>
							...
							<center><div id="documentViewer" class="flexpaper_viewer" style="width:100%;height:500px;border:solid 1px;"></div><br/>
							<div id="documentViewerQ" class="flexpaper_viewer" style="width:50%;height:500px;border:solid 1px;"></div><br/>
								<div id="documentViewerTopp" class="flexpaper_viewer" style="width:50%;height:500px;border:solid 1px;"></div>
