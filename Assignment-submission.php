...
<body>
	<div style='background-color:#fff;width:100%'>
				...
				<tr>
					...
					<?php
											$result_c=mysql_query("SELECT c.name,u.name FROM course c,user u WHERE c.id='$course_id' and u.id=c.tutor_id");
												...
												$subname=$row_c1[0];
												echo "<label style='float:left;color:#ffffff;'><font face='verdana' size='2' color='white' ><b>".$tutorname.">".$crname.">".$subname.">Assignment submission</b></font></label>";
		...
		$result_c1=mysql_query("SELECT srno FROM document_manager_subjective WHERE materialname='$qname'");
												$row_c1=mysql_fetch_array($result_c1);
												$qname_a_id=$row_c1[0];
												echo "<label >Assignment ID: ".$qname_a_id."</label>";
		?>
