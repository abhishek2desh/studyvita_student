...
<table id="main_div" style="border-radius: 5px;width:80%;height:100%;background: purple;">
	<tr>
		<td style="border-radius: 5px;width:80%;height:80px;background: #EEEEEE;">
			<center><table>
				<tr>
					<td><h1>Edutech India Online Test</h1></td>
				</tr>
			</table></center>
		</td>
	</tr>
							...
							<tr>
								<td valign="top" style="border-radius: 5px;width:100%;height:70px;background: #EEEEEE;">
									<table style="border-radius: 5px;width:100%;height:30px;background: #EEEEEE;">
										<tr>
											<td>
												Answer &nbsp;<input type="button" style="border-radius: 5px;background-color:green;" width="30px;" value="">
											</td>
											<td>
												Not Answer &nbsp;<input type="button" style="border-radius: 5px;background-color:red;" width="30px;" value="">
											</td>
											<td>
												Review &nbsp;<input type="button" style="border-radius: 5px;background-color:yellow;" width="30px;" value="">
											</td>
										</tr>
									</table>
									<table style="border-radius: 5px;width:100%;height:40px;background: #EEEEEE;">
										...
										<tr>
											...
											<td>
												<input type="button" id="final_test" class="myButton" style="border-radius: 5px;background-color:grey;" width="100px;" value="Final Submit">
											</td>
										</tr>
