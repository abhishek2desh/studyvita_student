...
//alert(datetime);
				...
				blink1();*/
					...
					$('#cancel_hide_allot_m').click(function(){
				//alert("l");
			currentdate = new Date();
								currentdate = moment(currentdate).format("YYYY-MM-DD HH:mm:ss");
								doc_end_time_menu=	currentdate;
							
filename = "query/update_menu_log_document.php?uid="+u_id+"&docid="+mat_id+"&start_time="+doc_start_time_menu+"&end_time="+doc_end_time_menu+"&page_source="+page_source_doc+"&submenu_with_menu="+submenu_with_menu;
...
filename1 = "query/insert_document_log.php?uid="+u_id+"&docid="+mat_id+"&start_time="+doc_start_time+"&page_source="+page_source;
								...
								filename1 = "query/insert_menu_log_document.php?uid="+u_id+"&docid="+mat_id+"&start_time="+doc_start_time_menu+"&page_source="+page_source_doc+"&submenu_with_menu="+submenu_with_menu;
										//alert(filename1);
										$.ajax({
										url: filename1,
										type: 'GET',
	...
	<div style='background-color:#fff;width:100%'>
		...
		<table style="border:px solid;width:100%;height:30px;">
					<tr>
						...
						<td style='width:2%;'>
							<center><img src="images/close_image.png" id='cancel_hide_allot_m' height="25px" width="25"></center>
						</td>
					</tr>
				</table>
	...
	function getDocumentUrl_img(document){
		...
		var startDocument_img = "<?php if(isset($_GET["doc"])){echo $_GET["doc"];}else{?>front screen.pdf<?php } ?>";
						...
						<div id="doc34" style="top:30px;">
									...
									<input type="button" class="defaultbutton" id="downloadsol" name="downloadsol" value="Download" />
						...
						<div style="border:solid 0px;width:100%;height:auto;"> 
							<table valign='top' id='view_result_omr' style="float:left;background:white;width:100%;">
								<tr>
									<td style="width:100%;">
										<div id="OMR_result" style="width:100%;background:white;">
			...
			flowplayer("wowza", "flowplayer-3.2.18.swf");
					...
					<td id='omr_sheet_display' valign='top' style="border:solid 0px;width:20%;padding-top:40px;"> 
						<!--<div id="selft_tester">
