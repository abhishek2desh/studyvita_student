<?php
	...
	$s1=$_GET['edutech_student1'];
	$s5=$_GET['user_id1'];
	$s3=$_GET['group_id'];
	$u5 = $_GET['student_name'];
...
<html>
	<head>
		...
		*/	
				...
				u1 = "../edutech_viewer/query/dignostic_chart1_prince.php?s=14&user_id="+user;
				u2 = "../edutech_viewer/query/dignostic_chart2_prince.php?s=14&user_id="+user;
				//alert(u1+u2);
				start();
		...
		*/
			...
			//	alert("physics..."+b);
				...
				u1 = "../edutech_student/query/dignostic_chart1_prince.php?s=16&user_id="+user;
				u2 = "../edutech_student/query/dignostic_chart2_prince.php?s=16&user_id="+user;
		...
		*/	
			...
			//	alert("mathematics..."+b);
				...
				u1 = "../edutech_student/query/dignostic_chart1_prince.php?s=15&user_id="+user;
				u2 = "../edutech_student/query/dignostic_chart2_prince.php?s=15&user_id="+user;
		...
		/*		chart1bio.destroy();
			...
			*/
			...
			//	alert("chemistry..."+b);
				...
				u1 = "../edutech_student/query/dignostic_chart1_prince.php?s=17&user_id="+user;
				u2 = "../edutech_student/query/dignostic_chart2_prince.php?s=17&user_id="+user;
		...
		/*		chart1bio.destroy();
			...
			*/
			...
			//	alert("chemistry..."+b);
				...
				u1 = "../edutech_student/query/dignostic_chart1_prince.php?s=18&user_id="+user;
				u2 = "../edutech_student/query/dignostic_chart2_prince.php?s=18&user_id="+user;
		...
		/*		chart1bio.destroy();
			...
			*/
			...
			//	alert("chemistry..."+b);
				...
				u1 = "../edutech_student/query/dignostic_chart1_prince.php?s=19&user_id="+user;
				u2 = "../edutech_student/query/dignostic_chart2_prince.php?s=19&user_id="+user;
		...
		/*		chart1bio.destroy();
			...
			*/
			...
			//	alert("chemistry..."+b);
				...
				u1 = "../edutech_student/query/dignostic_chart1_prince.php?s=22&user_id="+user;
				u2 = "../edutech_student/query/dignostic_chart2_prince.php?s=22&user_id="+user;
	...
	<div style="font-size:14px;">
		StudentID : <?php echo $s1; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		GroupID: <?php echo $s3; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		StudentName:<?php echo $u5; ?>
	</div>
	<br />
	<div id="grid">
	...
	<div id="chartScore">
		<table>
			<tr>
				<td><Button type="Button" class="defaultbutton" id="bio" value="14">Biology</button></td>
				<td><Button type="Button" class="defaultbutton" id="phy" value="16">Physics</button></td>
				<td><Button type="Button" class="defaultbutton" id="che" value="17">Chemistry</button></td>
				<td><Button type="Button" class="defaultbutton" id="mat" value="15">Mathematic</button></td>
				<td><Button type="Button" class="defaultbutton" id="sci" value="18">Science</button></td>
				<td><Button type="Button" class="defaultbutton" id="eng" value="19">English</button></td>
				<td><Button type="Button" class="defaultbutton" id="ss" value="22">Social Science</button></td>
			</tr>
		</table>
	</div>
