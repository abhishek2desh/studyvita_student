 ...
 AND sm.saas_id=um.saas_module_id AND sm.menu_id='$menuid' ORDER BY ml.priority ";
	...
	if($val_for_ct == 1)
				...
				while($row_sub_icon=mysql_fetch_array($result_sub_icon))
					...
					if($row_sub[0] == "Previous Competitive Paper")
							{
								goto nextmenu;
							}
							if($row_sub[0] == "Topper AnswerSheet")
							{
								goto nextmenu;
							}
					...
					$i=$i+1;
						if($row_sub[0]=="Buy Study Material" || $row_sub[0]=="Subscribe Material")
							...
							echo "<td align='center' style='border:solid 0px;width:20%;padding-left: 15px;'  valign='top'>";
									...
									echo "<a href='test_paper_generator_chapterwise.php' >";
									echo "<center><img src=images/submenu/1.png height='100%' width='100%'></center>";
									...
									echo "<a href='test_paper_generator_custom.php' >";
									echo "<center><img src=images/submenu/2.png height='100%' width='100%'></center>";
									...
									echo "<a href='test-paper-generator-unitwise.php' >";
									echo "<center><img src=images/submenu/3.png height='100%' width='100%'></center>";
							...
							echo "<td align='center' style='border:solid 0px;width:20%;padding-left: 15px;'  valign='top'>";
									...
									echo "<a href='test_paper_generator_request.php' >";
									echo "<center><img src=images/submenu/1.png height='100%' width='100%'></center>";
									...
									echo "<a href='insrtuction_part_request.php' >";
									echo "<center><img src=images/submenu/2.png height='100%' width='100%'></center>";
									echo "<h4>Take Test</h4>";
										echo "</a>";
										echo "</td>";
									...
									echo "<a href='view_my_mistakes_request.php' >";
									echo "<center><img src=images/submenu/3.png height='100%' width='100%'></center>";
									echo "<h4>View My Mistakes</h4>";
										echo "</a>";
										echo "</td>";
									...
									echo "<a href='view_my_result_request.php' >";
									echo "<center><img src=images/submenu/4.png height='100%' width='100%'></center>";
									echo "<h4>View Result</h4>";
										echo "</a>";
										echo "</td>";
							...
							echo "<td align='center' style='border:solid 0px;width:20%;padding-left: 15px;'  valign='top'>";
									...
									echo "<a href='personlized_paper_test.php?val=1' >";
									echo "<center><img src=images/submenu/1.png height='100%' width='100%'></center>";
									echo "<h4>Take Test</h4>";
										echo "</a>";
										echo "</td>";
									...
									echo "<a href='personlized_paper_test.php?val=2' >";
									echo "<center><img src=images/submenu/2.png height='100%' width='100%'></center>";
									echo "<h4>View My Mistakes</h4>";
										echo "</a>";
										echo "</td>";
									...
									echo "<a href='personlized_paper_test.php?val=3' >";
									echo "<center><img src=images/submenu/3.png height='100%' width='100%'></center>";
									echo "<h4>View Result</h4>";
										echo "</a>";
										echo "</td>";
							...
							echo "<td align='center' style='border:solid 0px;width:20%;padding-left: 15px;'  valign='top'>";
									...
									echo "<a href='comp-international.php' >";
									echo "<center><img src=images/submenu/3.png height='100%' width='100%'></center>";
							...
							echo "<td align='center' style='border:solid 0px;width:20%;padding-left: 15px;'  valign='top'>";
									...
									echo "<a href='https://studyvita.com/webinar.php' >";
									echo "<center><img src=images/submenu/4.png height='100%' width='100%'></center>";
							...
							else if($row_sub[0] == "Knowledge meter")
							{
								echo "<td align='center' style='border:solid 0px;width:20%;padding-left: 15px;'  valign='top'>";
									...
									echo "<a href='diagnostic_analysis_ch.php' >";
									echo "<center><img src=images/submenu/1.png height='100%' width='100%'></center>";
									...
									echo "<a href='diagnostic_analysis.php' >";
									echo "<center><img src=images/submenu/2.png height='100%' width='100%'></center>";
									//echo "<center><img src='images/submenu/1.png' height='100%' width='100%'></center>";
									...
									echo "<a href='PerformanceAnalysis.php' >";
									echo "<center><img src=images/submenu/3.png height='100%' width='100%'></center>";
									//echo "<center><img src='images/submenu/1.png' height='100%' width='100%'></center>";
							...
							echo "<td align='center' style='border:solid 0px;width:20%;padding-left: 15px;'  valign='top'>";
									...
									echo "<a href='insrtuction_part.php' >";
									echo "<center><img src=images/submenu/1.png height='100%' width='100%'></center>";
									echo "<h4>Take Test</h4>";
										echo "</a>";
										echo "</td>";
									...
									echo "<a href='view_my_mistakes_admin.php' >";
									echo "<center><img src=images/submenu/2.png height='100%' width='100%'></center>";
									//echo "<center><img src='images/submenu/1.png' height='100%' width='100%'></center>";
									echo "<h4>View My Mistakes</h4>";
										echo "</a>";
									...
									echo "<a href='view_my_result_admin.php' >";
									echo "<center><img src=images/submenu/3.png height='100%' width='100%'></center>";
									//echo "<center><img src='images/submenu/1.png' height='100%' width='100%'></center>";
									echo "<h4>View Result</h4>";
										echo "</a>";
							...
							echo "<td align='center' style='border:solid 0px;width:20%;padding-left: 15px;'  valign='top'>";
									...
									echo "<a href='insrtuction_part3.php' >";
									echo "<center><img src=images/submenu/1.png height='100%' width='100%'></center>";
									echo "<h4>Take Test</h4>";
										echo "</a>";
										echo "</td>";
									...
									echo "<a href='view_my_mistakes_adp.php' >";
									echo "<center><img src=images/submenu/2.png height='100%' width='100%'></center>";
									//echo "<center><img src='images/submenu/1.png' height='100%' width='100%'></center>";
									echo "<h4>View My Mistakes</h4>";
										echo "</a>";
									...
									echo "<a href='view_my_result_adp.php' >";
									echo "<center><img src=images/submenu/3.png height='100%' width='100%'></center>";
									//echo "<center><img src='images/submenu/1.png' height='100%' width='100%'></center>";
									echo "<h4>View Result</h4>";
										echo "</a>";
							...
							echo "<td align='center' style='border:solid 0px;width:20%;padding-left: 15px;'  valign='top'>";
									...
									echo "<a href='instruction_part_moc.php' >";
									echo "<center><img src=images/submenu/1.png height='100%' width='100%'></center>";
									echo "<h4>Take Test</h4>";
										echo "</a>";
										echo "</td>";
							...
							echo "<td align='center' style='border:solid 0px;width:20%;padding-left: 15px;'  valign='top'>";
								...
								$v1=1;
								echo "<td align='center' style='border:solid 0px;width:20%;padding-left: 15px;'  valign='top' >";
									echo "<a href=http://student.studyvita.com/virtual-class-n.php?course_id=".$course_id."&batch_id=".$batch_id."&subject_id=".$subject_id."&uid=".$s5."&vl=".$v1."&domainname=".$domaimname1."&name=".$u5." >";
									echo "<center><img src=images/submenu/$menu_icon_name style='width:200px; height:90px;'></center>";
									echo "<h4>$row_sub[0]</h4>";
										echo "</a></td>";
								}
