...
<tr>
		<td valign="top" style="border:solid 0px;width:60%;">
		<table style="width:100%">
		<tr style='background-color:#0f2541;'>
		<td style="width:100%">
		<label style='padding-left:5px;'><font face="verdana" size="4" color="white" >Select Unit</font></label><br/>
		</td>
		</tr>
		</table>
		...
		<td valign="top" style="padding-top:0px;border:solid 0px;width:40%;">
		...
		<label style='padding-left:5px;'><font face="verdana" size="4" color="white" >Chapter List</font></label><br/>
				...
				<td>
				<div class="scrollbar_div" id="style-7">
			<div id="cpt1" name="cpt1" style="border:solid 0px;width:100%;height:150px;">
...
<td style="width:40%;" valign="top">
 <img src="images/grey to green.png" style="width:100%;height:50%;">
		<font face='verdana'  size="2">Advantage of Diagnostic Test<br/></br>
