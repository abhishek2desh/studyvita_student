...
<head>		
		...
		var page_source="recommend-course.php";
...
filename = "query/update_menu_log.php?uid="+uid+"&docid="+currentdocid+"&start_time="+doc_start_time+"&end_time="+doc_end_time+"&page_source="+page_source+"&submenu_with_menu="+submenu_with_menu;
				...
				filename = "query/get-recommend_course.php?course_id="+course_id+"&batch_id="+batch_id+"&uid="+uid;
//alert(filename);
				...
				$("#search1").live('click',function(){
					...
					course_id="";
					 var balc = ($(this).closest('tr').attr('id'));
					  var mySplitResult7 = balc.split("|");
                    course_id = mySplitResult7[0];
					refer_code = mySplitResult7[1];
					//alert(course_id);
                    ...
                    $.ajax({
                        ...
                        success: function(data, textStatus, xhr) {
                            ...
                            url_reg = "http://www.coreacademics.in/pricing/index.php?uid=" + reg_uid + "&uname=" + reg_uname + "&course_id=" + course_id+ "&refer_code=" + refer_code;
//alert(url_reg);
		...
		?>
				...
				<tr>
					...
					<?php
												...
												$subname=$row_c1[0];
												echo "<label style='float:left;color:#ffffff;padding-left:5px;'><font face='verdana' size='2' color='white' ><b>Welcome &nbsp;&nbsp;&nbsp;".$u5."&nbsp;&nbsp;!&nbsp;&nbsp;&nbsp;&nbsp;".$tutorname.">".$crname.">".$subname.">"."Recommended Courses<b></font></label>";
			...
			<table style="width:100%;border:solid 0px;">
				<tr>
					<td>
						<div id="schedule_data" style="border:solid 1px;width:1200px;height:250px;overflow-y:scroll;padding-left:10px;"></div>
					</td>
				</tr>
			</table>
		</div>
