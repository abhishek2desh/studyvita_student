...
$("#cancel_hide_fac").click(function(){
		...
		var page_source="view_my_result_adp.php";
...
<!-- Animation Content Div -->
	...
	<div style='background-color:#fff;width:100%;height:1500px;'>
		...
		?>
				...
				<tr>
					...
					<?php
												...
												$subname=$row_c1[0];
												echo "<label style='float:left;color:#ffffff;'><font face='verdana' size='2' color='white' ><b>Welcome &nbsp;&nbsp;&nbsp;".$u5."&nbsp;&nbsp;!&nbsp;&nbsp;&nbsp;&nbsp;".$tutorname.">".$crname.">".$subname.">"."View Result<b></font></label>";
	...
	<input type="button" class="defaultbutton" id="brief_view_all" value="View All Faculty Profile">
				...
				<div id="faculty_list" name="faculty_list" style="border:solid 0px;overflow-y: 	scroll;background-color:white;width:100%;height:100px;">
						...
						Missing your favorite teacher? Invite him/her to join studyvita
							<input type='button' class='invite_teach' id='invite_teach' value='Invite Now' />
			</td>
			</tr>
			</table><br/>
