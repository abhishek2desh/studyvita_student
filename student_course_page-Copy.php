...
<body>
	<div style='background-color:#fff;width:100%'>
				...
				<tr>
					<td id='swf_hide' valign='top' style="border:solid 0px;width:80%;">
						<center><div id="doc34" style="top:30px;">
							<center><!--<input type="button" id="View_sol2" class="defaultbutton" name="View_sol2" value="View Solution" />-->
									<input type="button" id="topper_ans" class="defaultbutton" name="topper_ans" value="Topper AnswerSheet" />
									<!--<input type="BUTTON" id="print_paper" class="defaultbutton" value="Print"/></center>-->
							<div id="documentViewer" class="defaultbutton" style="width:100%;height:500px;border:solid 1px;"></div>
		...
		<div id="footer" style="background-color:#fcc998;">
			<center><img src="images/nodna.png" alt="Footer" width="100%" height="23px"></center>
		</div>
	</div>
			...
			<form method="post" enctype="multipart/form-data">
				<table style='width:420px;'>
					<tr>
						...
						<td>
							<input type='BUTTON' class="defaultbutton" id='submit_print' value='SUBMIT'/>
						</td>
					</tr>
					<tr>
						<td>
