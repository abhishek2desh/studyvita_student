<font face="verdana" size="4" color="white" ><table style="width:80%;">
<tr>
<td>
...
<tr>
<td>
<label ><font face="verdana" size="4" color="white" >Total MCQs in this course:</font> </label>
</td>
<td>
...
<br/>
<table class="main_div2" style="padding-top:50px;width:80%;border:solid 0px;">
	<tr>
		<td valign="top" style="border:solid 0px white ;60%";>
			<label ><font face="verdana" size="5" color="white" ><u>Select Chapter</u></font><font face="verdana" size="2" color="white" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Your Average Performance in %</font></label><br/>
			<div class="scrollbar_div" id="style-7">
			<div id="cpt" name="cpt" style="border:solid 0px;width:100%;height:250px;"></div>
			<center>
		...
		<td valign="top" style="padding-top:10px;border:solid 0px;width:40%;">
		<div id="topper"  style="width:100%";>
			...
			<table > 
				<tr>
					<td >
						<label id="rq_qus"><font face="verdana" size="4" color="white" >Number of Questions</font></label>
					</td>
					<td>
				...
				<tr>
					<td>
						<div class="set_time" style="padding-top:10px;">
							<label><font face="verdana" size="4" color="white" >Select Duration</label>
						</div>
					</td>
					<td>
