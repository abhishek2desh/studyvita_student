...
/*Animation Overlay CSS Ends*/
	...
	exitrec:
		...
		<div style='width:100%;height:auto;background:#34495e;'>
			<table style="padding-top:215px;border:solid 0px;width:100%;height:25px;">
			<!--<tr>
		...
		?></font>
				...
				<tr>-->
					<center><td style="border:solid 0px;background-color:#0f2541;">
					<?php
												...
												echo "<label style='float:left;color:#ffffff;'><font face='verdana' size='2' color='white' ><b>".$tutorname.">".$crname.">".$subname.">"."Unitwise Test</b></font></label>";
...
<div id="footer" >
		...
		<div  style="width:100%;">
				...
				<center><img src="images/footer final.png" style="height:auto;width:100%;"></center>
        </div>
    </body>
</html>