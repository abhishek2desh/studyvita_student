...
{	
	...
	$.ajax({
		...
		var page_source="view_my_result_unittest.php";
...
//alert(filename);
			...
			$("#shadow").fadeIn("normal");
				...
				sb12=sub_name_rs;
				sb11="";
				filename = "30_view_student_test_result_unit.php?uid="+uid+"&sb_result="+sb11+"&cp_result="+cp_result+"&std_result="+std_result;
			//alert(filename);
			...
			<table style="padding-top:85px;border:solid 0px;width:100%;height:25px;">
				<tr>
					...
					<?php
												...
												$subname=$row_c1[0];
												echo "<label style='float:left;color:#ffffff;padding-left:5px;'><font face='verdana' size='2' color='white' ><b>Welcome &nbsp;&nbsp;&nbsp;".$u5."&nbsp;&nbsp;!&nbsp;&nbsp;&nbsp;&nbsp;".$tutorname.">".$crname.">".$subname.">"."View Result Class<b></font></label>";
