				...
				<tr>
					...
					<td valign="top" style="border-radius: 10px;width:69.9%;height:488px;background: #EEEEEE;">
						...
						<div>
							...
							<input type="BUTTON" class="defaultbutton" id="sub_all" name="select_question" value="All"/>
						...
						<div style="padding-left:0px;width:99.5%;">	
								...
								<td valign="top" style="border-radius: 5px;width:100%;height:70px;background: #EEEEEE;">
									...
									<table style="border-radius: 5px;width:100%;height:40px;background: #EEEEEE;">
										...
										<tr>
											...
											<td>
												<input type="button" id="final_test"  style="border-radius: 5px;background-color:blue;" class="defaultbutton" width="100px;" value="Final Submission">
											</td>
										</tr>
