...
$insert_test=mysql_query("INSERT INTO adaptive_learning_test(`test_id`,`student_id`,`SUBJECT`,`noq`,`start_time`,`end_time`,`total_time`,`test_type`,batch_id)
	...
	$comb_chapter="";
	//end chapter
	$insert_test=mysql_query("INSERT INTO adaptive_learning_test(`test_id`,`student_id`,`SUBJECT`,`noq`,`start_time`,`end_time`,`total_time`,`test_type`,batch_id,blueprint_id)
				   VALUES('$test_id','$uid','$sub','$req_que','$start_time','$end_time','$t_t','$type','$batch_id','$bluprint_id')");
	}
	//
