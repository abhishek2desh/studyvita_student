...
//	$date = date("Y-m-d H:i:s"); ;
	...
	{	
		echo "<tr id='$row[7]'>";
			...
			{
				echo "<div style='color:red;font-size:14px;'>Expire Test - <input type='button' class='defaultbutton' value='View Result' /></div>";
			}
			else
			{
				...
				if($row_1[0] == 1)
				{
					echo "<input type='button' class='defaultbutton' value='View Result' />";
				}
				else
				{
					echo "<input type='button' class='defaultbutton' value='Start Test' />";
				}
			}
			echo "</td>";
		echo "</tr>";
