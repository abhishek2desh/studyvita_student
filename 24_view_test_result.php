				...
				while($row2=mysql_fetch_array($result2))
				{
					...
					else if($res != $corr_ans)
					{
						...
						echo "<td style='width:100px;border:solid px;height:20px;'><center><label style='color:black'><b>".$row[1]."</b></label></center></td>";
							...
							echo "<td style='width:140px;border:solid 0px;height:20px;'><center><input type='button' class='defaultbutton' id='my_mistakes' value='View My Mistakes' /></center></td>";
							echo "<td style='width:155px;border:solid 0px;height:20px;'><center><input type='button' class='defaultbutton' id='dig_report' value='View Report' /></center></td>";
						echo "</tr>";
						$j++;
