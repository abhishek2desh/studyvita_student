...
//alert(datetime);
				...
				filename ="query/check_user_gif_display1.php?user_id="+u_id+"&content_name="+content_name;
					//alert(filename);
						$.ajax({
						url: filename,
						type: 'GET',
	...
	<div style='background-color:#fff;width:100%'>
		<div class='trable_bg' style='position: fixed;z-index: 2;padding-left:0px;color:yellow;border:solid 0px;width:100%;padding-bottom:0px'>
			<table style='width:100%' cellspacing="0">
				...
				<tr>
					<td valign='bottom' style='width:100%;border:solid 0px;'>
		...
		<div style='background-color:#fff;width:100%'>
			<table  style="width:100%;border:solid 0px;padding-top:200px;">
<tr>
					...
					<?php
												...
												$subname=$row_c1[0];
												echo "<label style='float:left;color:#ffffff;'><font face='verdana' size='2' color='white' ><b>Welcome &nbsp;&nbsp;&nbsp;".$u5."&nbsp;&nbsp;!&nbsp;&nbsp;&nbsp;&nbsp;".$tutorname.">".$crname.">".$subname.">"."Study Material<b></font></label>";
...
<table  style="width:100%;border:solid 0px;">
				<tr>
					<td id='swf_hide' valign='top' style="border:solid 0px;width:80%;background-color:;">
	...
	function getDocumentUrl_img(document){
		...
		var startDocument_img = "<?php if(isset($_GET["doc"])){echo $_GET["doc"];}else{?>front screen.pdf<?php } ?>";
						...
						<div id="doc34" style="top:30px;">
										...
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" id="downloaddoc" name="downloaddoc" value="Download" class="defaultbutton"/>	
										<input type="button" id="downloadsol" name="downloadsol" value="Download" class="defaultbutton"/>
							<center><input type="button" id="View_sol2" name="View_sol2" value="View Solution" class="defaultbutton"/>
									<input type="button" id="topper_ans" name="topper_ans" value="Topper AnswerSheet" class="defaultbutton"/>
									<input type="BUTTON" id="print_paper" value="Print" class="defaultbutton"/></center>
							<center><div id="documentViewer" class="flexpaper_viewer" style="width:100%;height:900px;border:solid 1px;"></div>
							<br/>
							<div id="documentViewer_QT"  style="width:100%;border:solid 0px;">
							<table style="width:100%;border:solid 0px;">
							<tr>
							<td>
							<div id="documentViewerQ" class="flexpaper_viewer" style="width:100%;height:900px;border:solid 0px;"></div>
							</td>
							<td>
							<div id="documentViewerTopp" class="flexpaper_viewer" style="width:100%;height:900px;border:solid 0px;"></div>
							</td>
							</tr>
							...
							<table valign='top' id='view_result_omr' style="float:left;background:#E0ECF8;width:100%;">
								...
								<tr>
									<td valign='top' id="re_test_score">
										...
										<input type="button" id="View_Solution" name="OMR_View_Result" style="color:blue;" value="View Solution" class="defaultbutton"/>
									</td>
								</tr>
							</table>
						</div>
						...
						<div id="Show_OMR_Div" style='width:100%;'>
							...
							<div id="sheet" style='width:100%;'>
								<table style="width: 100%;height: 110px; background-color:#FFFFFF;border:1px solid blue;">
									<tr style="height:100%;">
										<td style="height:100%;">
											<div id="dv" style="width:100%;border:solid 1px;height:790px;overflow:scroll;">
											</div>
			...
			<form method="post" enctype="multipart/form-data">
				<table style='width:450px;'>
					<tr>
						...
						<td>
							<input type='BUTTON' id='submit_print' value='SUBMIT' class="defaultbutton"/><br/><br/>
							<input type='BUTTON' id='submit_print_close' value=' CLOSE ' class="defaultbutton"/>
						</td>
					</tr>
					<tr>
						<td>
