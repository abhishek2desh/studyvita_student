...
<!-- this is subjective paper test anchor tag -->
	...
	<body oncontextmenu="return false">
		...
		?>
			...
			<!--<blink>
				<input type="button" id="result_of_tempry_test" class="defaultbutton" style="color:blue;" value="Result" />
				</link>
			-->
			</div>
												...
												<table style="width: 10px;height: 110px; background-color:#FFFFFF;border:1px solid blue;">
													...
													<tr style="height:100%;">
														<td >
															...
															<input type="button" class="defaultbutton" id="OMR_online_answer_submit" name="OMR_online_answer_submit" style="color:red" value="Final Submit" />
															<input type="button" class="defaultbutton" id="OMR_online_View_Result" name="OMR_online_View_Result" value="View Result" />
														</td>
													</tr>
												</table>
											</div>
					...
					<tr>
						<td><div class='demo'>
							...
							<tr><td><table>
								<tr>
								<td>
									<input type="button" class="defaultbutton" id="prev_lect_tt" value="Previous Lecture" />
								</td>
								
								<td>
									<input type="button" class="defaultbutton" id="td_lect_tt" value="Today's Lecture" />
								</td>
								</tr>
							</table></td>
							</tr>
