...
<head>		
		...
		var page_source="comp-international.php";
		var sub_menu_name="Upcoming Competitions";
		...
		?>
				...
				<tr>
					...
					<?php
												...
												$subname=$row_c1[0];
												echo "<label style='float:left;color:#ffffff;padding-left:5px;'><font face='verdana' size='2' color='white' ><b>Welcome &nbsp;&nbsp;&nbsp;".$u5."&nbsp;&nbsp;!&nbsp;&nbsp;&nbsp;&nbsp;".$tutorname.">".$crname.">".$subname.">"."Upcoming Competitions International<b></font></label>";
				...
				<form method="post" enctype="multipart/form-data">
						...
						<div id="ppt_id" name="ppt_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:98%;height:230px;">No Data Available</div>
						</center>
						</div>
