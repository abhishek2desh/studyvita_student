...
session_start();
	...
	$result_12=mysql_query("SELECT DISTINCT m.id FROM `document_manager_subjective` dms,material m WHERE dms.MaterialName='$mnm' AND dms.Srno=m.`DocumentManager_RefID`");
