				...
				<div class="tabs-spacer"></div>
					...
					<div id="tabs-7" name="course_progress">
							<div>
								...
								-->
										<input type="BUTTON" name="chart" class="defaultbutton" value="View Graphically Course Progress" id="chart">
									</br>
									</br>
							...
							<tr>
								...
								<td>
									<div id="additional_topic_cover">
										...
										<input type="text" id="atcvr" value="" placeholder="Additional Topic " style="width:250px;" class="defaultbutton" />
