...
<title>Edutech Viewer - Username and Password</title>
...
<script type="text/javascript">
	var filename11="processor.php?dt=";
			...
			$('#search').click(function(event)
				{
					...
					var s = ($("#search_sid").val());	
					//alert(filename11+s);
					getContent(filename11+s);	
				});
				
			$('#assign').click(function()
				{
					var s = ($("#search_sid").val());	
					var filename="pdf2server.php?dt1="+s;
					//alert(filename);
					getPdf(filename);
				});
...
<body>
	...
	<!--<h1>Click here for your Download Diagnostic Test Report (pdf)</h1>-->
	<h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<strong>Download Diagnostic Test Report (pdf)</strong></h1>
	<div>
    	<label for="login_username">Student ID</label> 
    	<input type="hidden" name="std_id" id="search_sid" class="field required" title="Please Provide Your Student ID" />
    </div>
	<div id="data1">
	</div>
	<div class="submit">	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="submit" class="defaultbutton" value="Submit" id="search" name="submit-form" />   
		<?php //echo "&nbsp;&nbsp;&nbsp;";		?>
		
	<!--	<input type="button" class="defaultbutton" value="Go to Login" id="search22" onclick="window.location = 'login.php';">
	-->
