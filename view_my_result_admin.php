...
{	
	...
	$.ajax({
		...
		var page_source="view_my_result_admin.php";
										...
										success: function(data, textStatus, xhr) {
											...
											if(data == "")
											{
												...
												$.ajax({
													...
													$("#virtual_id").html("");
						filename = "query/get-virtual-class-schedule-chapter-test.php?sub_id="+sub_id+"&batch_id="+batch_id+"&uid="+uid+"&test_id="+tt_id;
...
window.scrollBy(0,300);
				...
				getContent(filename, "virtual_id");
				$("#faculty_list").html("");
				filename = "query/get-facultylist-testid.php?sub_id="+sub_id+"&course_id="+course_id+"&test_id="+tt_id;
				getContent(filename, "faculty_list");
						}
						else
						{
				...
				sb11="";
				filename = "30_view_student_test_result3.php?uid="+uid+"&sb_result="+sb11+"&cp_result="+cp_result+"&std_result="+std_result+"&test_type="+test_type;
				//alert(filename);
