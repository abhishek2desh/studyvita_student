...
filename = "query/update_document_log.php?uid="+uid+"&docid="+currentdocid+"&start_time="+doc_start_time+"&end_time="+doc_end_time+"&page_source="+page_source;
	...
	var url5="http://student.coreacademics.in/upload-assignment-sheet.php";
...
<body bgcolor="white">
	...
	<div style='background-color:white;width:100%;'>
		...
		<div style='background-color:white;width:100%;padding-top:25px;'>
	...
	<div id='Assignment_pendinglist' style="border:solid 1px;width:100%;height:250px;overflow-y: scroll;">
								<?php
									...
									while($row=mysql_fetch_array($result))
									{
										...
										echo "<td style='border:solid 1px;'><center><input type='button' class='defaultbutton' id='search1_asnt' value='Submit Now' style='width:100%;'/></center></td>";
										echo "</tr>";
									}
...
(SELECT DISTINCT `material_id` FROM `student_upload_assignment` WHERE `user_id`='$s5')");
									while($row=mysql_fetch_array($result_sub))
									{
										...
										echo "<td style='border:solid 1px;'><center><input type='button' class='defaultbutton' id='search_sub_t' value='Submit Now' style='width:100%;'/></center></td>";
										echo "</tr>";
									}
