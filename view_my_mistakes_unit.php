...
<head>		
		...
		var page_source="view_my_mistakes_unit.php";
...
filename = "query/update_menu_log.php?uid="+uid+"&docid="+currentdocid+"&start_time="+doc_start_time+"&end_time="+doc_end_time+"&page_source="+page_source+"&submenu_with_menu="+submenu_with_menu;
				...
				sb12=sub_name_rs;
				sb11="";
				filename = "test_paper_generator/20_get_test_id6.php?sub_id="+sb11+"&uid="+uid;
				//alert(filename);
			...
			filename = "test_paper_generator/20_get_test6_id.php?sub_id="+sb11+"&uid="+uid+"&dt1="+datepickerVal44+"&dt2="+datepickerVal45;
				//alert(filename);
				getContent(filename, "test_id");
				...
				$( "#datepicker45" ).datepicker({
					...
					onSelect: function() { 
						datepickerVal45 = $("#datepicker45").val();
						sb11=$("#sub_id_select").val();
						filename = "test_paper_generator/20_get_test_id6.php?sub_id="+sb11+"&uid="+uid+"&dt1="+datepickerVal44+"&dt2="+datepickerVal45;
						//alert(filename);
						getContent(filename, "test_id");
					}
				});
