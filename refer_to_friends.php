			...
			<tr>
				...
				<div style="padding-top:0px;">
					<table>
						<tr>
							<td>
								<input type="BUTTON" id='add_refer' name='add_refer' value="Add Reference" class="defaultbutton" />
							</td>
							<td>
								<input type="BUTTON" id='list_refer' name='list_refer' value="List Reference Details" class="defaultbutton"/>
							</td>
				...
				<div class="add_refer_class" style="padding-top:30px;padding-left:20px;width:450px;height:300px;">
					...
					<table style="width:450px;border:solid 1px;height:200px;">
						...
						<tr>
							<td>
								<input type="BUTTON" id="bt_id" name="bt_id" value="Submit" class="defaultbutton"  />
							</td>
						</tr>
						<tr>
							<td>
