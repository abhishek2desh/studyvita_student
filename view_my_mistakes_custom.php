...
<head>		
		...
		var page_source="view_my_mistakes_custom.php";
...
filename = "query/update_menu_log.php?uid="+uid+"&docid="+currentdocid+"&start_time="+doc_start_time+"&end_time="+doc_end_time+"&page_source="+page_source+"&submenu_with_menu="+submenu_with_menu;
				...
				filename = "test_paper_generator/20_get_test_id_custom.php?sub_id="+sb11+"&uid="+uid+"&dt1="+datepickerVal44+"&dt2="+datepickerVal45;
				//alert(filename);
