...
<head>		
		...
		<script>
			$(document).ready(function(){
				...
				{				//$("#homeimg").show();
					//callFlexPaperDocViewerImg("front screen.pdf");
				}
				/*var blink = function() {
					$('#View_sol2').animate({
						opacity: '0'
			...
			<table  style="width:100%;height:1000px;border:solid 0px;">
				<tr>
					...
					<?php
						...
						?>
						<div id="homeimg" >
						<div id="documentViewerImg" class="flexpaper_viewer"  style="width:100%;height:900px;border:solid 0px;"></div>
						<script type="text/javascript">
									function getDocumentUrl1(document){
										//alert(document);
									...
									function getDocQueryServiceUrl1(document){
										return "services/swfsize.php?doc={doc}&page={page}".replace("{doc}",document);
									}
									var startDocument3 = "<?php if(isset($_GET["doc"])){echo $_GET["doc"];}else{?>front screen.pdf<?php } ?>";
									$('#documentViewerImg').FlexPaperViewer(
									 {
										config : {
											 DOC : escape(getDocumentUrl1(startDocument3)),
											 Scale : 0.6,
											 ...
											 DocSizeQueryService : 'services/swfsize.php?doc=' + startDocument3,
											 jsDirectory : 'js/',
									...
									function callFlexPaperDocViewerImg(startDocument1){
										...
										$('#documentViewerImg').FlexPaperViewer({
											config : {
											 ...
											 DOC : escape(getDocumentUrl1(startDocument1)),
											 Scale : 0.1,
											 ZoomTransition : 'easeOut',
											 ZoomTime : 0.5,
											 ZoomInterval : 0.2,
			...
			<form method="post" enctype="multipart/form-data">
				<table style='width:420px;'>
					<tr>
						...
						<td>
							<input type='BUTTON' id='submit_print' value='SUBMIT' class='defaultbutton'/>
						</td>
					</tr>
					<tr>
						<td>
