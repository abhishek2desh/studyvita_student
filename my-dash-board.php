	...
	<div style='background-color:#fff;width:100%'>
		<div class='trable_bg' style='position: fixed;z-index: 2;padding-left:0px;color:yellow;border:solid 0px;width:100%'>
			<table style='width:100%' cellspacing="0">
				...
				<tr>
					<td valign='bottom' style='width:100%;border:solid px;'>
		...
		<table style="padding-top:235px;border:solid 0px;width:100%;height:25px;">
		<!--<tr>
		...
		?>
				...
				<tr>
					<center>
					 ...
					 <td style="border:solid 0px;background-color:#0f2541;">
					...
					<?php
												...
												$subname=$row_c1[0];
												echo "<label style='float:left;color:#ffffff;'><font face='verdana' size='2' color='white' ><b>Welcome &nbsp;&nbsp;&nbsp;".$u5."&nbsp;&nbsp;!&nbsp;&nbsp;&nbsp;&nbsp;".$tutorname.">".$crname.">".$subname.">"."Virtual Class<b></font></label>";
...
while($row_unit=mysql_fetch_array($result_unit))
			...
			<div class="imagelist" style="border:solid 0px;width:100%;height:320px;paddong-left:0px;">
			<center><font color="#1b4268" size="5"><i><br/><br/><br/>Do not share your User name and Password with your Friends.<br/>
