...
<body>
	<div style='background-color:#EDF5FA;width:100%'>
		...
		<div style='background-color:#EDF5FA;width:100%;height:1000px;'>
			...
			<tr>
			<td>
			<input type='button' class='analysis_ch' id='analysis_ch' value='Chapterwise Analysis' />
				<input type='button' class='analysis_unit' id='analysis_unit' value='Unitwise Analysis' />
			</td>
			</tr>
			</table>
		</div>
