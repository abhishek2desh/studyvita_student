...
<div style="background-color:#0174DF;border:solid 0px;width:100%;height:121px;">
	<div style="font-size:12px;color:yellow;text-transform: capitalize;">
			<table style="background-color:#0174DF;border:solid 0px;width:100%;height:60px;">
				<tr>
					<td  style="float:left;border:solid 0px;width:auto;height:58px;">
						<?php
							if($branch == 20)
							{
						?>
					...
					<td style="float:left;border:solid 0px;width:auto;height:58px;">
						<table valign="top" style="background-color:#0174DF;border:solid 0px;width:100%;height:58px;">
							<tr>
								<td style="font-size:18px;border:solid 0px;width:100%;height:24px;">
									<center>Integrated Diagnostic Adaptive Learning Programme [IDALP] </center>
								</td>
							</tr>
							<tr>
					...
					<?php 
						// images size is width 274 and height:60
						if($branch == 20)
						{
						}
						...
						{
							?>
							<td style="float:left;padding-left:10px;width:auto;height:58px;">
					...
					?>
					<td style="float:left;">
						<div style="border:solid 1px;width:70px;height:57px;">
							<?php
					...
					<td style="float:left;">
						<div style="border:solid 0px;width:auto;height:57px;">
							<?php 
