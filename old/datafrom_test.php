...
<html>
<head>
<title>Study Vita | Information</title>
...
<script>
		...
		//var orderid=1;
			...
			document.getElementById('id1').value = order_id;
			document.getElementById('id2').value = totalamt;
			document.getElementById('id3').value = uname;
...
<body>
	<form method="post" name="customerData" action="ccavRequestHandler.php">
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b>Order Information</b></font></caption></table>
		<div id="dv1">
			
			<table width="40%" height="100" border='1' align="center">
			<tr>
				<td>Order Id	:</td><td><input type="text" name="order_id" value="" id='id1' readonly /></td>
				
			</tr>
			<tr>
					<td>Amount	:</td><td><input type="text" name="amount" value="" id='id2' readonly /></td>
			</tr>
			<tr>
		        	<td>Name	:</td><td><input type="text" name="billing_name" value="" id='id3'readonly /></td>
		     </tr>
			 <tr>
		...
		<div id="dv2" class='sel_med'>
			<table width="40%" height="100" border='1' align="center">
				<tr>
					<td>TID	:</td><td><input type="text" name="tid" id="tid" readonly /></td>
				</tr>
				<tr>
					<td>Merchant Id	:</td><td><input type="text" name="merchant_id" value="61313"/></td>
				</tr>
				<tr>
					<td>Currency	:</td><td><input type="text" name="currency" value="INR"/></td>
				</tr>
				<tr>
					<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="http://student.studyvita.com/ccavResponseHandler.php"/></td>
				</tr>
			 	<tr>
			 		<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="http://www.studyvita.com"/></td>
			 	</tr>
			 	<tr>
				...
				<tr>
					<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="http://www.studyvita.com/ccavResponseHandler.php"/></td>
				</tr>
			 	<tr>
			 		<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="http://www.studyvita.com/ccavResponseHandler.php"/></td>
			 	</tr>
			 	<tr>
					<td>Language	:</td><td><input type="text" name="language" value="EN"/></td>
				</tr>
