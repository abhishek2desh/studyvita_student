...
<script> 
	$(document).ready(function(){
		...
		filename = "query/get_subject_id.php?get_test_id="+test_id;
		$.ajax({
			url: filename,
			type: 'GET',
			dataType: 'html',
		...
		function timer_set()
		{
			setInterval(function() 
			{
				 ...
				 filename = "query/updatet_time.php?s2="+s2+"&user_id="+uid+"&test_id_new="+test_id;
				 //alert(filename);
				 $.ajax({
					url: filename,
					type: 'GET',
		...
		filename = "query/5_min_val_get.php?get_test_id="+test_id;
		//alert(filename);
		$.ajax({
			url: filename,
			type: 'GET',
			...
			success: function(data, textStatus, xhr) {
				...
				//alert(s);
				filename = "query/22_it.php?sub="+sub_id+"&test_id="+test_id+"&req_que="+max_val+"&date_time="+s+"&date_time2="+date_time2+"&t_t="+t_t+"&select_test_wise="+select_test_wise+"&uid="+uid;
				//alert(filename);
				$.ajax({
					url: filename,
					type: 'GET',
					...
					success: function(data, textStatus, xhr) {
						...
						filename = "query/1_quesion_no_display.php?get_test_id="+test_id+"&uid="+uid;
						//alert(filename);
						...
						function() {
							 ...
							 filename = "query/23_insert_adaptive.php?date_time2="+s2+"&new_test_id="+test_id;
							 //alert(filename);
							 $.ajax({
								url: filename,
								type: 'GET',
							...
							setTimeout(function(){
								document.location.href="insrtuction_part.php";
							}, 3000);
						});
					},
				});
		...
		$("#sub_phy").click(function(){
			...
			$("#sub_che,#sub_bio,#sub_mat,#sub_sce").css('color','white');
			sb_select=1;
			check_name=ck_phy;
			$("#selected_subject").html("Physics");
			filename = "query/3_view_ok_button.php?uniq_id_get="+uniq_id_get+"&marks_for_review="+marks_for_review+"&marks_for_atm="+marks_for_atm+"&get_test_id1="+test_id+"&uid="+uid+"&sub="+sb_select;
			//alert(filename);
			getContent3(filename, "view_que_sel");
		});
		$("#sub_che").click(function(){
			$(this).css('color','black');
			$("#sub_phy,#sub_bio,#sub_mat,#sub_sce").css('color','white');
			sb_select=2;
			check_name=ck_che;
		...
		$("#sub_bio").click(function(){
			$(this).css('color','black');
			$("#sub_che,#sub_phy,#sub_mat,#sub_sce").css('color','white');
			sb_select=6;
			check_name=ck_bio;
		...
		$("#sub_mat").click(function(){
			$(this).css('color','black');
			$("#sub_che,#sub_bio,#sub_phy,#sub_sce").css('color','white');
			sb_select=3;
			check_name=ck_mat;
		...
		$("#sub_sce").click(function(){
			$(this).css('color','black');
			$("#sub_che,#sub_bio,#sub_mat,#sub_phy").css('color','white');
			sb_select=7;
			check_name=ck_sce;
		...
		$('#save_next').click(function(){
			...
			else
			{
				...
				filename = "query/22_insert_response.php?uniq_id_get="+uniq_id_get+"&qno="+check_name+"&select_ans_wise="+select_ans_wise+"&get_test_id1="+test_id+"&uid="+uid;
				//alert(filename);
				$.ajax({
					url: filename,
					type: 'GET',
		...
		$('#clear_response').click(function(){
			filename = "query/15_clear_response.php?uniq_id_get="+uniq_id_get+"&qno="+check_name+"&get_test_id1="+test_id+"&uid="+uid;
			//alert(filename);
			$.ajax({
				url: filename,
				type: 'GET',
