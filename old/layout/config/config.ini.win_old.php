...
allowcache = 1
splitmode = 0
path.pdf = "C:\xampp\swf\test_flexpaper_docs\"
path.swf = "C:\xampp\swf\test_flexpaper_flex\"
renderingorder.primary = "flash"
renderingorder.secondary = "html"
cmd.conversion.singledoc = "\"C:\Program Files\SWFTools\pdf2swf.exe\" \"{path.pdf}{pdffile}\" -o \"{path.swf}{pdffile}.swf\" -f -T 9 -t -s storeallcharacters -s linknameurl"
...
cmd.conversion.jsonfile = "\"C:\Program Files\PDF2JSON\pdf2json.exe\" \"{path.pdf}{pdffile}\" -enc UTF-8 -compress \"{path.swf}{jsonfile}\""
