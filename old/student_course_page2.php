...
var blink = function() {
						...
						filename="query/get_student_website.php?uid="+uid;
									$.ajax({
										...
										success: function(data, textStatus, xhr) {
											...
											url_reg="http://"+mySplitResult[1]+"/pricing.php?uid="+reg_uid+"&uname="+reg_uname;
											//alert(url_reg);
  ...
  padding-bottom: 15px;'>
						...
						<table id="2tablt"  style='border:solid 0px;width:100%;height:140px;  background: url(images/bg-white-lock.png) repeat;
  width: 360px;
  margin: 0 auto;
  margin-bottom: 0px;
  padding: 30px;
  ...
  padding-bottom: 15px;'>
			...
			<p><center>
			<section >
	<button class="btn btn-3 btn-3e" onclick="location.href='#'" id='reg_new_course' >Buy New Courses</button>		
</section></center>
</p>
