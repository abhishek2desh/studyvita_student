<?php
    ...
    $yourbrowser= "Your browser: " . $ua['name'] . " " . $ua['version'] . " on " .
			...
			<input type="submit" name="demo_show" class="button_css" id="demo_show" value="Click Here For A Demo" />
			<?php
				if($url_link_val == 1)
				{	
						...
						<tr>
							...
							<td style="padding-top:20px;">
								<table>
									<tr>
										<td>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" class="button_css name="parent_login" id="login123" value="Submit" />
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<input type="button" class="button_css" id="cancel_hide" value="Cancel" />
										</td>
									</tr>
								</table>
							</td>
