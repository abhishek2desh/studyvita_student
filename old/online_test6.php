					...
					<td valign="top" style="border-radius: 10px;width:69.9%;height:488px;background: #EEEEEE;">
						...
						<div style="padding-left:20px;width:99.5%;">	
							...
							<table>
								<tr>
									<td>
										<input type="BUTTON" class="button_css" style="width:130px;" id="previous_bt" name="previous_bt" value="Previous"/>
									</td>
									<td>
									...
									<td>
										<input type="BUTTON" class="button_css" style="width:120px;" id="next_bt" name="next_bt" value="Next"/>
									</td>
								</tr>
							</table>
						</div>
