            ...
            alert("idle window");
				...
				$( "#datepicker37" ).datepicker({
					...
					onSelect: function() { 
						...
						sb11=$("#sb").val();
						filename = "30_view_student_test_result_all.php?uid="+uid+"&sb_result="+sb11+"&cp_result="+cp_result+"&std_result="+std_result+"&sorttype="+sorttype+"&fromdate="+strdt1+"&todate="+strdt2;
					//alert(filename);
				...
				sb11=0;
					//filename = "30_view_student_test_result.php?uid="+uid+"&sb_result="+sb11+"&cp_result="+cp_result+"&std_result="+std_result+"&sorttype="+sorttype+"&fromdate="+datepickerVal37+"&todate="+datepickerVal38;
			...
			<table style="padding-top:0px;border:solid 0px;width:100%;height:25px;">
				<tr>
					<td style="background-color:#3366FF;border:solid 0px;">
						<label style="float:left;color:white"><b>Performance Analysis</b></label>
					</td>
				</tr>
			</table>
			<div>
