...
echo "<td style='color:white;border:solid 0px;width:12%'>
					<input type='BUTTON' value='View Demo' id='democourse' name='democourse' class='myButton'/>
				</td>";
				...
				{
					//echo "<td style='color:white;border:solid 0px;width:10%'>
						//<input type='BUTTON' value='Register Now' id='course_reg' name='course_reg' class='myButton'/>
					  //</td>";
					  echo "<td style='color:white;border:solid 0px;width:12%'>
					<input type='BUTTON' value='View Demo' id='democourse' name='democourse' class='myButton'/>
				</td>";
