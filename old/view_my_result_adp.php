		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$('#cp_list').change(function(){
					...
					filename = "30_view_student_test_result5.php?uid="+uid+"&sb_result="+sb_result+"&cp_result="+cp_result+"&std_result="+std_result;
					//alert(filename);
					getContent_hide(filename, "view_result_of_adaptive_test_student");
				});
			});
...
<body>
	<div style='background-color:#EDF5FA;width:100%;height:1500px;'>
