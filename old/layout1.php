...
<script> 
	$(document).ready(function(){
		...
		filename = "query_jee/get_subject_id.php?get_test_id="+test_id;
		$.ajax({
			url: filename,
			type: 'GET',
			dataType: 'html',
		...
		filename = "query_jee/5_min_val_get.php?get_test_id="+test_id+"&user_id="+uid;
		//alert(filename);
		$.ajax({
			url: filename,
			type: 'GET',
			...
			success: function(data, textStatus, xhr) {
				...
				//alert(s);
				filename = "query_jee/22_it.php?sub="+sub_id+"&test_id="+test_id+"&req_que="+max_val+"&date_time="+s+"&date_time2="+date_time2+"&t_t="+t_t+"&select_test_wise="+select_test_wise+"&uid="+uid;
				//alert(filename);
				$.ajax({
					url: filename,
					type: 'GET',
					...
					success: function(data, textStatus, xhr) {
						...
						function() {
							 ...
							 filename = "query_jee/23_insert_adaptive.php?date_time2="+s2+"&new_test_id="+test_id;
							 //alert(filename);
							 $.ajax({
								url: filename,
								type: 'GET',
		...
		$("#sub_phy").click(function(){
			...
			filename = "query_jee/3_view_ok_button.php?uniq_id_get="+uniq_id_get+"&marks_for_review="+marks_for_review+"&marks_for_atm="+marks_for_atm+"&get_test_id1="+test_id+"&uid="+uid+"&sub="+sb_select;
			//alert(filename);
		...
		$('#view_que_sel').click(function(){
			...
			//path="R:\\QuestionData\\"+""+uniq_id_get_qus;
			...
			filename = "query_jee/14_response_checked.php?uniq_id_get="+uniq_id_get+"&qno="+check_name;
			$.ajax({
				url: filename,
				type: 'GET',
				dataType: 'html',
