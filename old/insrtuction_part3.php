				...
				<tr>
					<td valign="top" style="border-radius: 5px;width:69.9%;background: #EEEEEE;">
						<div style="border-radius: 5px;border:solid 1px;width:99.5%;height:30px;background-color:#EEEEEE;">
							<center><input type="BUTTON" class="button_css" id="next_clicl_bt" value="Click To Next"/><input type="BUTTON" class="button_css" id="generates_clicl_bt" value="Click To Generates"/></center>
						</div>
					</td>
				</tr>
			</table>
