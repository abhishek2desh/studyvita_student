...
<!--	<script type="text/javascript" src="js/jquery.min.js"> </script>	-->
		...
		$(document).ready(function(){
		   ...
		   $("#emax_schedule").click(function(){
				$("#shadow1").fadeIn("normal");
				$("#examination_Schedule").fadeIn("normal");
				filename="forth2/view_data2.php";
				//alert(filename);
				getContent(filename,"view_data");
			});
			$("#cancel_hide2").click(function(){
				$("#examination_Schedule").fadeOut("normal");
				$("#shadow1").fadeOut();
		   });
	...
	<body bgcolor="white">
						...
						<div class='main_div' style='width:1050px;height:430px;border-radius: 20px; border: 3px solid #BADA55;'>
							...
							<table>
								<tr>
									...
									<td>
										<center>
											<a href='#' id='emax_schedule'><div class="myDiv" style='width:250px;height:180px;border-radius: 20px; border: 3px solid #BADA55;'>
												<table>
													<tr>
														<td style='width:250px;height:150px;border-radius: 20px; border: 0px solid #BADA55;'>
															<center><img src='images/ScheduleR.jpg' height='150px' width='130px'></center>
														</td>
													</tr>
													<tr>
														<td style='width:250px;height:30px;'>
															<b><center>Examination Schedule</center></b>
														</td>
													</tr>
												</table>
											</div></a>
							...
							<table>
								<tr>
									<td>
										<center>
											<a href="http://www.globaleduserver.com/Default.aspx"><div class="myDiv" style='width:250px;height:180px;border-radius: 20px; border: 3px solid #BADA55;'>
												<table>
													<tr>
														<td style='width:250px;height:150px;border-radius: 20px; border: 0px solid #BADA55;'>
										...
										<center>
											<a href='dignostic_report34.php'><div class="myDiv" style='width:250px;height:180px;border-radius: 20px; border: 3px solid #BADA55;'>
												<table>
													...
													<tr>
														<td style='width:250px;height:30px;'>
															<b><center>Offline result and report</center></b>
														</td>
													</tr>
												</table>
											</div></a>
		...
		<div id="examination_Schedule">
			<div class="err" id="add_err"></div>
			<table style="background-color:#0174DF;border:2px solid;width:100%;height:30px;">
				<tr>
					<td style='width:95%;'>
						<center><strong><label style="color:white">Examination Schedule</label></strong></center>
					</td>
					<td style='width:5%;'>
						<center><img src="images/close_image.png" id='cancel_hide2' height="20px" width="25"></center>
					</td>
				</tr>
			</table>
			<table style='width:100%;height:auto;'>
				<tr>
					<td style='width:100%;'>
						<div id="view_data" class='view_data' style="height:250px;border: 1px solid black;overflow-y: scroll;">
						</div>
					</td>
				</tr>
			</table>
		</div>
		<div id="shadow1" class="popup"></div>
		<?php
