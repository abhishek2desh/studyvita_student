<?php	
	...
	$result3=mysql_query("SELECT DISTINCT ta.duration FROM test_announce ta,que_paper q WHERE ta.que_paper_id=q.id AND q.name='$get_test_id' AND ta.user_id='$user_id'");
