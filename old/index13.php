...
<!-- this is subjective paper test anchor tag -->
					...
					<div id="filter_sub_chap" style="padding-left:10px;float:left;">
						<table class="lg-container" style="border:solid 0px;padding-top:10px;width: 1015px;">
							<tr>
								...
								<td style="padding-left:0px;float:left"><input type="BUTTON" name="ok_bt" id="ok_bt" value="OK" class="button_css"></td>
							</tr>
						</table>
					</div><?php
				}
	...
	<table style="border:solid 1px;width:1290px;" align="left">
		<tr>
			<td style="padding-left:20px;float:left"><input type="BUTTON" name="print_bt" id="print_bt" value="Add this document to print-list" class="button_css"></td>
		</tr>
		<tr>
