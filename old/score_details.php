...
<html>
	...
	<div id="chartScore" style="border:solid 0px;width:100%;;height:30px;">
		<table>
			<tr>
				<td>
					<Button type="Button" id="bio" value="BIO">Biology</button>
				</td>
				<td>
					<Button type="Button" id="phy" value="PHY">Physics</button>
				</td>
				<td>
					<Button type="Button" id="che" value="CHE">Chemistry</button>
				</td>
				<td>
					<Button type="Button" id="mat" value="MAT">Mathematics</button>
				</td>
			</tr>
		</table>
	</div>
