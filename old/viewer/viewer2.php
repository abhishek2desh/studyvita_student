<div id="documentViewer" class="flexpaper_viewer" style="padding-top:1px;padding-left:2px;border-radius: 5px;width:99.9%;height:400px"></div>
<script type="text/javascript">
	...
	var startDocument = "<?php if(isset($_GET["doc"])){echo $_GET["doc"];}else{?>ADP_NEW.pdf<?php } ?>";
