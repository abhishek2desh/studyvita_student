<div id="documentViewer3" class="flexpaper_viewer" style="padding-top:1px;padding-left:2px;border-radius: 10px;width:99.5%;height:373px"></div>
<script type="text/javascript">
	...
	$('#documentViewer3').FlexPaperViewer(
	 {
		config : {
	...
	function callFlexPaperDocViewer3(startDocument1){
