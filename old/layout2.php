			...
			$.ajax({
				...
				success: function(data, textStatus, xhr) {
					...
					function() {
						...
						filename = "test_paper_generator/23_insert_adaptive_final.php?date_time2="+s2+"&test_id="+test_id+"&uid="+uid;
						 //alert(filename);
						 $.ajax({
							url: filename,
							type: 'GET',
							...
							success: function(data, textStatus, xhr) {
								if(data == 'true')
								{
									setTimeout(function(){
										...
										document.location.href="view_my_result_adp.php";
									}, 3000);
								}
							},
						});
	...
	<tr>
		<td style="border-radius: 5px;width:80%;height:80px;background: #EEEEEE;">
			<center><table style="width:100%;">
				<tr>
					<td align="center" style="width:90%;"><h1>Adaptive Test</h1></td>
							...
							<table style="padding-top:5px;width:100%;">
								<tr>
									...
									<td style='width:55%'>
										...
										<input type="BUTTON" class="button_css" style="width:100px;" id="save_next" name="save_next" value="Save & Next"/>
									</td>
								</tr>
							</table>
						</div>
