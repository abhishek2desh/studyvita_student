...
<body>
	...
	<p class="register">Set Password then Click here <a href="login.php">Login</a></p>
	<h1>Register for your <strong>Edutech Viewer</strong> account!</h1>
	
	<div>
    	<label for="login_username">Student ID</label> 
    	<input type="text" name="std_id" id="search_sid" class="field required" title="Please provide your username" value="<?php echo $stud_id; ?>"/>
    </div>
	...
	<div class="submit">
		<input type="submit" value="Search" id="search" name="submit-form" />    
	</div>
