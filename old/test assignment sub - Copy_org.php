				...
				<center><table style="padding-left:20px;border:solid 0px;width:40%%;height:25px;">
					<tr>
						<td style="border:solid 0px;width:20%;height:30px;">
							<input type="button" id="assinment_schedule" style='height:40px;' class='main_div2' value="Assignment schedule"/>
						</td>
						<td style="border:solid 0px;width:20%;height:30px;">
							<input type="button" id="forth_schedule" style='height:40px;' class='main_div2' value="ForthComing schedule"/>
						</td>
					</tr>
				</table></center><br/>
