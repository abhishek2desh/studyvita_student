...
{	
	...
	$.ajax({
		...
		var page_source="view_my_result_custom.php";
...
window.scrollBy(0, 300);
			...
			//alert(filename);
				...
				sb11="";
				filename = "30_view_student_test_result_custom.php?uid="+uid+"&sb_result="+sb11+"&cp_result="+cp_result+"&std_result="+std_result;
			//alert(filename);
				getContent_hide(filename, "view_result_of_adaptive_test_student");
