					...
					<div  style='width:70%;height:220px;border:solid 0px;'>
						<table id="1tablt"  style='border:solid 1px;width:100%;height:200px;'>
							...
							<tr>
								...
								<td style='width:60%;'>
								<div class="form-4">
								<input type="submit1" class="defaultbutton" name="submit1" value="Continue" id='log-submit1'>
								</div>
								</td>
							</tr>
						</table>
						...
						<!--<table class='main_div' style='border:solid 1px;width:100%;height:30px;'>
							<tr>
								<td>
									<center><input type='Button' class='defaultbutton' value='Join New Course Click Here' id='join_new_course'></center>
								</td>
							</tr>
						</table>-->
				</div></center>
		...
		<div id="reg_batch_dis1">
			...
			<form action="" style="width:100%;">
				...
				<div id='registered_dt' class='main_div' style="background-color:#0174DF;border:2px solid;width:98%;height:auto">
					...
					<table>
						<tr>
							<td><center><input type='BUTTON' class='defaultbutton' id='submit' name='submit' value='SUBMIT'/></center></td>
						</tr>
					</table>
				</div>
			</form>
