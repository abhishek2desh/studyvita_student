				...
				<table style="border:solid 0px;width:100%;">
					<tr>
						...
						<td valign="top" style="border:solid 0px;width:10%;">
							<div>
								<input type="BUTTON" id="view_course_progress_dt" style="float:right;padding-left: 5px;width:100%;height:50px;" name='view_course_progress_dt' value="Pending Course Progress" class="defaultbutton"/>
							</div>
						</td>
					</tr>
				</table>
...
$result=mysql_query("SELECT DISTINCT c.id,c.name FROM working_batches_coursewise wb,course c
	WHERE work_date='$today' AND wb.course_id = c.id AND wb.user_id='$batch_id'");								
