				...
				<table style="border:solid 0px;width:100%;height:auto;">
					...
					<tr>
						<td>You need to improve in the following concepts to get a better score in the EXAM.
							You are advised to revise the below mentioned topics. Further you are advised to workout the personal assignment and submit it online. Personal assignments will be uploaded in your Viewer Account. (Your username is <?php echo $username; ?> and password is <?php echo $password; ?>).</td>
					</tr>
				</table>
				<br/>
				<?php
