...
<head>		
		...
		var page_source="usefullink-stu.php";
...
filename = "query/update_menu_log.php?uid="+user_id+"&docid="+currentdocid+"&start_time="+doc_start_time+"&end_time="+doc_end_time+"&page_source="+page_source+"&submenu_with_menu="+submenu_with_menu;
				...
				online_id2="";
										...
										online_id3 = ($(this).closest('td').attr('id'));
										//alert(online_id2);
										if(online_id2=="")
										{
										...
										{
										filename ="query/checkvideoexist.php?videoUrl="+online_id3;
						//alert(filename);
						//alert(online_id2);
						$.ajax({
								url: filename,
		...
		?>
				...
				<tr>
					...
					<?php
												...
												$subname=$row_c1[0];
												echo "<label style='float:left;color:#ffffff;padding-left:5px;'><font face='verdana' size='2' color='white' ><b>Welcome &nbsp;&nbsp;&nbsp;".$u5."&nbsp;&nbsp;!&nbsp;&nbsp;&nbsp;&nbsp;".$tutorname.">".$crname.">".$subname.">"."Useful Link<b></font></label>";
				...
				<form method="post" enctype="multipart/form-data">
						...
						<div id="ppt_id" name="ppt_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:98%;height:150px;">
						<?php
						$result=mysql_query("SELECT s.id,s.description,l.link_type,s.link_name,s.user_type,u.name,DATE_FORMAT(s.create_date,'%d-%m-%Y'),s.approve_status,s.approved_user_id,DATE_FORMAT(s.approved_date_time,'%d-%m-%Y  %h:%i %p') FROM `suggested_link_library` s,link_type l,user u
WHERE l.id=s.link_type and u.id=s.user_id  and s.user_type like '%,5,%' and  s.approve_status='1' ORDER BY s.id DESC");
$rw = mysql_num_rows($result);
		...
		else
		{
			...
			echo "<tr>";
			echo "<th style='border:solid 1px;' width='70%'>Description</th>";
			echo "<th style='border:solid 1px;' width='15%'>Link Type </th>";
			echo "<th style='border:solid 1px;' width='15%'></th>";
			echo "</tr>";
			while($row=mysql_fetch_array($result))
			{
				echo "<tr id='$row[3]'>";
				...
				echo "<td style='border:solid 1px;' id='$row[0]'><center><input type='button' class='defaultbutton' id='search1' value='Open' style='width:50%;'/></center></td>";
				echo "</tr>";
			}
			echo "</table>";
		}
