...
left: 28px; top: -2px; margin: 0; border: none; width: 23px; height: 23px; box-shadow: 0 0 4px rgba(0,0,0,0.1); 
  ...
  setInterval(function(){
      $('blink').each(function(){
		...
		var page_source="virtual-class-n.php";
		...
		currentdate = new Date();
								...
								filename1 = "query/insert_menu_log_document.php?uid="+uid+"&docid="+currentdocid+"&start_time="+doc_start_time_menu+"&page_source="+page_source_doc+"&submenu_with_menu="+submenu_with_menu;
										//alert(filename1);
										$.ajax({
										url: filename1,
										type: 'GET',
...
filename = "query/update_menu_log_document.php?uid="+uid+"&docid="+currentdocid+"&start_time="+doc_start_time_menu+"&end_time="+doc_end_time_menu+"&page_source="+page_source_doc+"&submenu_with_menu="+submenu_with_menu;
...
$uid=$s5;
	...
	if($flg==1)
	{
		echo "<marquee> <a href='insrtuction_part.php' target='_blank' ><font size='4'> Click Here</a> to start Learn n' Win contest</font></marquee><br/>";
			...
			<a href='test_paper_generator.php' target='_blank' class='btn btn-sm style4 hover-blue' style="width:100px;color:red;"><font size='2.5'><b>Adaptive Learning</b></font></a>
			...
			echo "<a href=http://www.coreacademics.in/edushopee/index.php?uid=".$s5."&uname=".$u5." class='btn btn-sm style4 hover-blue' style='width:100px;color:red;'><font size='2.5'>";
			...
			$result=mysql_query("SELECT id,NAME FROM user WHERE id='$s5' and faculty_id is not null");
							...
							if($res>0)
							{
							echo "<a href='#' class='btn btn-sm style4 hover-blue' style='width:100px;color:red;' id='facultylive'><font size='2.5'><b>Go to Faculty Login</b></font></a>";
							}
			?>
			</center>
			</td>
...
while($row_unit=mysql_fetch_array($result_unit))
			...
			<tr class="dtwise" >
					<td style="width:100%;padding-left:20px;">
						<div id="schedule_data" style="border:solid 1px;width:98%;height:250px;overflow-y:scroll;padding-left:0px;"></div>
					</td>
				</tr>
			</table>
...
?>
			...
			<center><table style='width:100%;' class="matlist">
								<tr>
									...
									<th style='width:100%;background-color:#0f2541'>
									<label style='font-size:16px;font-color:orange'><font color="orange">MATERIAL LIST</font></label>
								...
								<center><table style='width:90%;'>
										...
										<td style='width:20%;' valign="top">
											<table style='width:100%;'>
												...
												<tr>
													<td style='width:100%;'>
													<div  id="ppt_id" name="ppt_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:113px;"></div>
													</td>
												</tr>
											</table>
											...
											<table style='width:100%;'>
												...
												<tr>
													<td style='width:100%;'>
													<div  id="not_id" name="not_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:113px;"></div>
													</td>
												</tr>
											</table>
											...
											<table style='width:100%;'>
												...
												<tr>
													<td style='width:100%;'>
													<div  id="vod_id" name="vod_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:113px;"></div>
													</td>
												</tr>
											</table>
										...
										<table style='width:100%;'>
												...
												<tr>
													<td style='width:100%;'>
													<div  id="top_id" name="top_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:113px;"></div>
													</td>
												</tr>
											</table>
											...
											<table style='width:100%;'>
												...
												<tr>
													<td style='width:100%;'>
													<div  id="weblink_id" name="weblink_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:113px;"></div>
													</td>
												</tr>
											</table>
										...
										<td style='width:60%;' valign="top">
											<table style='width:100%;'>
												<tr>
													<tr style='width:100%;'>
													<center><font color="#1b4268" size="5"><label id="chaptername">&nbsp;&nbsp;</label></font></center>
													</tr>
												</tr>
												<tr>
										...
										<table style='width:100%;'>
												<tr>
													<td style='width:100%;'>
													<center><img src="images/book-tablet.jpg" style="width:auto;height:auto;"  ></center>
													</td>
												</tr>
												<tr>
													<td style='width:100%;height:150px;' valign="top">
												<center><input type="BUTTON" id="booklink" name="booklink" value="View Textbook" class="defaultbutton"></center>
													</td>
												</tr>
											</table>
										<br/>
										...
										<table style='width:100%;'>
												...
												<tr>
													<td style='width:100%;height:35px;' valign="bottom"><font size="3">
											Content and Look and Feel of Studyvita are always evolving in nature. We welcome your valuable suggestions. You may write to info@coreacademics.in </font>
													</td>
												</tr>
											</table>
										<br/>
										...
										<table style='width:100%;'>
												...
												<tr>
													<td style='width:100%;'>
													<div  id="maz_id" name="maz_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:113px;"></div>
													</td>
												</tr>
											</table>
										</td>
										...
										<table style='width:100%;'>
												...
												<tr>
													<td style='width:100%;'>
													<div  id="descq_id" name="descq_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:113px;"></div>
													</td>
												</tr>
											</table>
										</td>
										...
										<table style='width:100%;'>
												<tr>
													<th style='width:100%;background-color:#0f2541;'>
														<font color="yellow">Miscellaneous</font>
													</th>
												</tr>
												<tr>
													<td style='width:100%;'>
													<div  id="misc_id" name="misc_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:113px;"></div>
													</td>
												</tr>
											</table>
										</td>-->
										...
										<td style='width:20%;' valign="top">
											<table style='width:100%;'>
												...
												<tr>
													<td style='width:100%;'>
													<div  id="das_id" name="das_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:113px;"></div>
													</td>
												</tr>
											</table>
											...
											<table style='width:100%;'>
												...
												<tr>
													<td style='width:100%;'>
													<div  id="oas_id" name="oas_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:113px;"></div>
													</td>
												</tr>
											</table>
											...
											<table style='width:100%;'>
												...
												<tr>
													<td style='width:100%;'>
													<div  id="dtp_id" name="dtp_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:113px;"></div>
													</td>
												</tr>
											</table>
										...
										<table style='width:100%;'>
												...
												<tr>
													<td style='width:100%;'>
													<div  id="otp_id" name="otp_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:113px;"></div>
													</td>
												</tr>
											</table>
										...
										<table style='width:100%;'>
												...
												<tr>
													<td style='width:100%;'>
													<div  id="prt_id" name="prt_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:113px;"></div>
													</td>
												</tr>
											</table>
		...
		<div id="login_form_material">
			...
			<form action="" style="width:100%;">
				...
				<input type="BUTTON" id="submit_sol" name="submit_sol" value="View Solution" class="defaultbutton"></input>
					...
					<tr>
					<td><input type="button" class="downpdf" id="downpdf" value=" Download Pdf  " class="defaultbutton"></td>
					<td>
					<?php
 ...
 WHERE us.user_id='$login_session_id' AND s.id=us.scheme_id");
		...
		echo "Download Rate Per Page: Rs. ".$drate;
					...
					<tr>
					<td><input type="button" class="downword" id="downword" value="Download Word" class="defaultbutton"></td>
					<td>
					<?php
