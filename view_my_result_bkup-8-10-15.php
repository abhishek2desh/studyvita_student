	...
	<div style='background-color:#fff;width:100%'>
		...
		<div style='background-color:#fff;width:100%;height:1000px;'>
			<table style="padding-top:0px;border:solid 0px;width:100%;height:25px;">
				<tr>
					...
					<?php
												...
												$subname=$row_c1[0];
												echo "<label style='float:left;color:#ffffff;'><font face='verdana' size='2' color='white' ><b>".$crname.">".$subname.">"."View Result</b></font></label>";
			...
			<input type='button' class='defaultbutton' id='analysis_ch' value='Chapterwise Analysis' />
				...
				<input type='button'  class='defaultbutton' value='View My Mistakes' onclick="window.location.href='view_my_mistakes.php'"/>
			</td>
			</tr>
			</table><br/>
			<table style="width:100%;">
