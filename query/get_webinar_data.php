<?php
	...
	$formatDate = date("Y-m-d H:i:s", $futureDate);
	 ...
	 IF(w.to_date < '$formatDate', 'expire','start ')) AS diff,w.conducted_by,w.channelno
FROM `webinar_detail` w,USER u,webinar_faculty_id wf WHERE (wf.user_id='$fac_id' or w.conducted_by='$fac_id')  and u.id=w.conducted_by and wf.webinar_id=w.id ORDER BY w.class_date,w.from_time ");
