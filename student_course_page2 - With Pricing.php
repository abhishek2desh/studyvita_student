...
var blink = function() {
			...
			<div style='width:100%;height:150px;border:solid 0px;'>
				<center>
					...
					<div  style='width:100%;height:220px;border:solid 0px;'>
						<table id="1tablt"  style='border:solid 0px;width:100%;height:200px;  background: url(images/bg-white-lock.png) repeat;
  width: 360px;
  margin: 0 auto;
  margin-bottom: 0px;
  padding: 30px;
  ...
  padding-bottom: 15px;'>
						...
						<table id="2tablt"  style='border:solid 0px;width:100%;height:200px;  background: url(images/bg-white-lock.png) repeat;
  width: 360px;
  margin: 0 auto;
  margin-bottom: 0px;
  padding: 30px;
  ...
  padding-bottom: 15px;'>
			...
			<center><div style="background-color: #FF9009;  width: 56%;  padding: 10px;" >
			<font color="white">Site best viewed in google chrome with minimum screen resolution of 1366x768 or higher.</font>
			</div>
			<div class="CSSTableGenerator" style='width:56%;'>
			<table>
			<tr>
			<td style='width:95%;'>
					<ul class="input-list style-1 clearfix">
					 <li>
					 <input type='text' id='sid' placeholder='Enter Referral code to redeem discount'  class="style-1" style="padding" maxlength="6"/> 
					 </li>
					
					 </ul>
					 </td>
			 <td  valign="bottom" style='width:5%;'>
			  <img src='images/enter5.png'  id='search3' >
			</td>
					</tr>
					</table></center></div>
			<center><div id='reg_show' style='  width: 70%;
  ...
  padding-top: 20px;'>
			...
			<div>
					<table style='width:100%;height:40px;'>
						<tr>
							<td style='background:#118C4E ;width:100%;'>
								<center><label style='color:white;'>New Course Registration</label></center>
							</td>
							<td style='width:5%;'>
					...
					<table style='background: #fafafa;width:100%;height:auto;font-size:16px;'>
						<tr>
							...
							Grand Total(<label style='color:red;' id='grand_total_cart'></label>)
								...
								<td style='width:20%;padding:10px;'>
							Total Discount(<label style='color:red;' id='grand_total_dis'></label>)
							</td>
					...
					<table style='background: #;border:solid 0px;width:100%;height:auto;'>
						<tr>
							<td style='width:100%;'>
							<div class="scrollbar_div" id="style-7">
								<div id="sesarch_tution" style="background:#;border:0px solid;width:100%;height:210px;">
									</div>
								</div>
							</td>
						</tr>
...
<script src="js/classie1.js"></script>
		...
		<center><div style="padding-bottom:-20px" ><section><button id="btn-click" class="btn btn-7 btn-7a icon-truck defaultbutton">Proceed to Checkout</button>
	</section>
</div></center>
		<!--<div id="otp_get">
		...
		<div id="reg_batch_dis1">
			...
			<form action="" style="width:100%;">
				...
				<div id='registered_dt' class='main_div' style="background-color:#0174DF;border:2px solid;width:98%;height:auto">
					...
					<table>
						<tr>
							<td><center><input type='BUTTON' id='submit' class="defaultbutton" name='submit' value='SUBMIT'/></center></td>
						</tr>
					</table>
				</div>
			</form>
