			...
			<div style="border:solid 1px;width:100%;height:auto;">
				...
				<table style="border:solid 1px;width:100%;height:auto;">
					...
					<?php
						...
						if($rw_nw23[0]=="4" && $rw_nw23[1]=="1")
						{
						echo "<tr><td style='border:solid 1px;'>Correct : $rw_nw23[0], Incorrect : $rw_nw23[1], Unanswer:0 [KEAM score]</td><td style='border:solid 1px;'><center>$final_cr/$tt</center></td></tr>";
						}
						else
						{
						echo "<tr><td style='border:solid 1px;'>Correct : $rw_nw23[0], Incorrect : $rw_nw23[1], Unanswer:0</td><td style='border:solid 1px;'><center>$final_cr/$tt</center></td></tr>";
						}
				...
				<?php
					...
					?>
						<table style="border:solid 1px;width:100%;height:auto;">
							<tr>
								<td style="border:solid 0px;width:100%"><b><?php echo $sub; ?></b><td>
								<!--<td style="border:solid 0px;width:50%"><td>-->
							</tr>
							<tr>
							<td style="border:solid 1px;width:100%">Micro Concept Gaps (Grey Area)<td>
								<!--<td style="border:solid 1px;width:50%">Unattempted Concepts<td>
								<td style="border:solid 1px;width:50%">Incorrect Concepts<td>-->
							</tr>
							<tr>
								<td valign='top' style="border:solid 1px;width:100%">
									<?php 
											//echo $unans_str;
											$str1_temp1=",";
											$concept_temp1="";
					...
					else
					{
						...
						else
						{
							while($row2=mysql_fetch_array($result_2))
							{
								...
								<table style="border:solid 1px;width:100%;height:auto;">
									<tr>
										<td style="border:solid 0px;width:100%"><b><?php echo $sub_id_d; ?></b><td>
<!--<td style="border:solid 0px;width:50%"><td>-->
									</tr>
									<tr>
																<td style="border:solid 1px;width:100%">Micro Concept Gaps (Grey Area)<td>

										<!--<td style="border:solid 1px;width:100%">Unattempted Concepts<td>
										<td style="border:solid 1px;width:50%">Incorrect Concepts<td>-->
									</tr>
									<tr>
										<td valign='top' style="border:solid 1px;width:100%">
			...
			<table style="border:solid 0px;width:100%;height:auto;">
					<tr>
						<td style="border:solid 0px;width:30%;height:auto;">
							<div style='font-family:  Arial;font-size:17px;'>UNIT WISE ANALYSIS (MACRO CONCEPT GAP ANALYSIS)</div>
						</td>
					</tr>
				</table>
				<?php
						...
						<td style="border:solid 0px;width:100%;height:auto;">
							<table style="border:solid 1px;width:100%;height:auto;">
								...
								<tr>
									...
									$rw_cnt = mysql_num_rows($result3);
									if($rw_cnt==0)
									{
									$result3=mysql_query("SELECT DISTINCT sb.unit_id,ut.unit_name FROM studenttestwise_unitper sb,unit ut WHERE sb.unit_id=ut.id AND sb.user_id='$student_user_id' AND sb.subject_id='$sub_id_d_1'");
									}
