...
<body bgcolor="#D8B2D8">
	...
	<div style='background-color:#D8B2D8;width:100%;'>
		...
		<div style='background-color:#D8B2D8;width:100%;padding-top:50px;'>
...
?>
			...
			<center><table style='width:100%;' class="matlist">
								
								<tr>
								<td valign="top" style='width:100%;'>
								<table style='width:100%;' cellspacing="5" >
								<tr>
								<th style='width:25%;background-color:#0f2541;'>
								
										<font color="yellow">PPT</font>
									</th>
								<th style='width:25%;background-color:#0f2541;'>
									...
									<th style='width:25%;background-color:#0f2541;'>
										...
										<font color="yellow">Video</font>
									</th>
									<th style='width:25%;background-color:#0f2541;'>
								
										<font color="yellow">TopperAnswerSheet</font>
									</th>
								</tr>
								<tr >
								
								<td style='width:25%;' >
									<div  id="ppt_id" name="ppt_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:75px;font-size:12px;"></div>
								</td>
								<td style='width:25%;'>
									<div  id="not_id" name="not_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:75px;font-size:12px;"></div>
								</td>
								<td style='width:25%;'>
									<div  id="vod_id" name="vod_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:75px;font-size:12px;"></div>
								</td>
								<td style='width:25%;'>
									<div  id="top_id" name="top_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:75px;font-size:12px;"></div>
								</td>
								</tr>
								</table>
								<table style='width:100%;' cellspacing="5" >
								...
								<th style='width:25%;background-color:#0f2541'>
										...
										<font color="yellow">Descriptive Assignment</font>
									</th>
								<th style='width:25%;background-color:#0f2541'>
								
										<font color="yellow">Objective Assignment</font>
									</th>
									<th style='width:25%;background-color:#0f2541'>
								
										<font color="yellow">Descriptive Test Paper</font>
									</th>
									<th style='width:25%;background-color:#0f2541'>
								
										<font color="yellow">Objective Test Paper</font>
									</th>
								</tr>
								<tr>
								<td style='width:25%;'>
									<div  id="das_id" name="das_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:75px;font-size:12px;"></div>
								</td>
								<td style='width:25%;'>
									<div  id="oas_id" name="oas_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:75px;font-size:12px;"></div>
								</td>
								<td style='width:25%;'>
									<div  id="dtp_id" name="dtp_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:75px;font-size:12px;"></div>
								</td>
								<td style='width:25%;'>
									<div  id="otp_id" name="otp_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:75px;font-size:12px;"></div>
								</td>
								</tr>
								</table>
								<table style='width:100%;' cellspacing="5">
								...
								<th style='width:25%;background-color:#0f2541'>
										...
										<font color="yellow">Weblink</font>
									</th>
								<th style='width:25%;background-color:#0f2541'>
								
										<font color="yellow">Magazine Link</font>
									</th>
									<th style='width:25%;background-color:#0f2541'>
								
										<font color="yellow">Descriptive Questions</font>
									</th>
									<th style='width:25%;background-color:#0f2541'>
								
										<font color="yellow">Previous Year Papers</font>
									</th>
								</tr>
								<tr>
								<td style='width:25%;'>
									<div  id="weblink_id" name="weblink_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:75px;font-size:12px;"></div>
								</td>
								<td style='width:25%;'>
									<div  id="maz_id" name="maz_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:75px;font-size:12px;"></div>
								</td>
								<td style='width:25%;'>
									<div  id="descq_id" name="descq_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:75px;font-size:12px;"></div>
								</td>
								<td style='width:25%;'>
									<div  id="prt_id" name="prt_id" style="border:solid 1px;overflow-y: 	scroll;background-color:white;width:100%;height:75px;font-size:12px;"></div>
								</td>
								</tr>
								</table>
								</td>
