...
if(isset($_POST['submit-login'])) { 
	...
	if($userTools->login($name, $password)){ 
		//successful login, redirect them to a page
		header("Location: index.php");
	}else{
		$error = "Dear $name, Please Check your Username and Password, Try again.";
	}
}
?>
...
<form id="login" method="post" action="login.php"> 
    ...
    <h1>Log in to your <strong>Edutech Viewer</strong> account!</h1>
 <!--   <p class="register">Not a member? <a href="register.php">Register here!</a></p>		-->
    
    <div>
    	<label for="login_username">Username</label> 
    	<input type="text" name="name" id="login_username" class="field required" title="Please provide your username" value="<?php echo $name; ?>"/>
    </div>			
 ...
 <!--   <p class="forgot"><a href="forgotPassword.php">Forgot your password?</a></p>	-->
    ...
    <div class="submit">
		<input type="submit" class="defaultbutton" value="Login" name="submit-login" id="submitButton" />
    </div>  
...
<?php
	...
	//	mysql_pconnect("localhost","edutechviewer34","edutechviewer34");
		...
		$result=mysql_query("Select * from student where name='$user'");
