                                                            ...
                                                            while ($row1 = mysql_fetch_array($result1)) {
																...
																else
																{
																 echo "<tr>";
                                                                    ...
                                                                    echo "<td style='border:solid 1px;' id='$row1[0]'><input class='defaultbutton' type='BUTTON' value='Upgarde Now' id='democourse_up' name='democourse_up' /></td>";
                                                                    echo "</tr>";
                                                        ...
                                                        while ($row = mysql_fetch_array($result)) {
															...
															// echo "<td style='border:solid 1px;' id='$row[0]'><font color='white'>" . $row[5] . "</font></td>";
															  $today = date("Y-m-d", strtotime('today'));
																...
																{
																 echo "<td style='border:solid 1px;' id='$row[0]'><font color='white'>" . $row[5] . "</font><input class='defaultbutton' type='BUTTON' value='Renew Now' id='course_up' name='course_up' /></td>";
																}
																else
																{
																 echo "<td style='border:solid 1px;' id='$row[0]'><font color='white'>" . $row[5] . "</font><input class='defaultbutton' type='BUTTON' value='Renew Now' id='course_up' name='course_up' /></td>";
