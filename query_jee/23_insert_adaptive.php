<?php
	...
	$result_test=mysql_query("SELECT DISTINCT ta.test_date,ta.user_id,s.name,ta.description,ta.faculty_id,ta.batch_id FROM test_announce ta,que_paper q,SUBJECT s WHERE q.id=ta.que_paper_id AND q.name='$new_test_id' AND ta.user_id='$user_id' AND s.id=ta.sub_id ");
		...
		$todayis = date("l, F j, Y, g:i a") ;
			...
			else
			{
				...
				$mail->Body = "
							...
							Subject : $subject1<br/>
							Test Description  : $chapter<br/><br/>
							Correct : $k<br/>
							Incorrect : $j<br/>
							Unattempted : $i<br/><br/>
