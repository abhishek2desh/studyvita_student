	...
	while($row=mysql_fetch_array($result))
	{
		...
		if($row[5]=="")
			...
			if($row[11] == 1)
			{
				...
				echo "<td style='color:black;border-bottom:2px solid #005000;width:25%;'>".$chapter."</td>";
				echo"<td style='color:black;border-bottom:2px solid #005000;width:35%;'>".$row[9]." To ".$row[10]."</td>
			...
			else
			{
				...
				else
				{
					...
					{
					$act="a";
					echo "<td style='width:10%;color:black;border-bottom:2px solid #005000;'><input type='checkbox' name='$row[4]' id='$row[0]-$row[1]-$row[2]-$row[3]-$row[7]-$row[8]-$row[12]-$act' class='$row[5]' value='$row[7]' value='$row[0]' />".$row[0]."</td></center>";
					}
					else
					{
					$act="s";
