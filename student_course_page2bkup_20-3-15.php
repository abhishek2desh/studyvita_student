...
<html lang="en">
	...
	<div style='width:100%'>
		...
		<div id="reg_batch_dis1">
			...
			<form action="" style="width:100%;">
				...
				<div id='registered_dt' class='main_div' style="background-color:#0174DF;border:2px solid;width:98%;height:auto">
					...
					<table>
						<tr>
							<td><center><input class="defaultbutton" type='BUTTON' id='submit' name='submit' value='SUBMIT'/></center></td>
						</tr>
					</table>
				</div>
			</form>
		...
		<div id="footer">
			<center><div style="padding-top:5px;font-size:12px;color:black;text-transform: capitalize;"><label style="border:solid 0px;color:white;">Powered by Globaleduserver.com Copyright &copy Edutech Educational Services Pvt. Ltd. Ahmedabad, Gujarat, India</label>
			</div></center>
		</div>
