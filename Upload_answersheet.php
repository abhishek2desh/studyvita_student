<?php
	...
	if(isset($_POST['submit2']))
	{
		...
		$totalpage_upload = preg_match_all("/\/Page\W/", $pdftext, $dummy);
		if($totalpage_upload>10)
		{
		$message2="You can upload file upto 10 pages at time.Please split file and upload.".$totalpage_upload;
				echo "<script language=javascript> alert('$message2');</script>";
		}
		else
		{*/
						...
						//$temp_path="R:\\StudentAnswersheet\\".$docname;
						//$temp_path1="R:\\StudentAnswersheet\\".$docname1;
						//$temp_path2="L:\\StudentAnswersheet\\".$docname;
						//$temp_path3="L:\\StudentAnswersheet\\".$docname1;
						//check file exist
							$result11=mysql_query("SELECT filename_new FROM `student_upload_answersheet` where filename_new='$uploadfilename_new' ");
						...
						//end cheking
						/*if (file_exists($temp_path) || file_exists($temp_path1) || file_exists($temp_path2) || file_exists($temp_path3) )
						{
						$docname=$testid."_".$s5."_".$i.".doc";
						$docname1=$testid."_".$s5."_".$i.".pdf";
						$uploadfilename_new=$testid."_".$s5."_".$i;
						...
						$temp_path1="R:\\StudentAnswersheet\\".$docname1;
						$temp_path2="L:\\StudentAnswersheet\\".$docname;
						$temp_path5="L:\\StudentAnswersheet\\".$docname1;
						if (file_exists($temp_path) || file_exists($temp_path1) || file_exists($temp_path2) || file_exists($temp_path3) )
						{
...
<head>		
		...
		var page_source="Upload_answersheet.php";
				...
				$("#test_id input:radio:checked").each(function() {
					...
					//alert(document_no);
						...
						else
						{
							...
							url="http://www.globaleduserver.com/edu/edutech_viewer_flex/view-checked-answersheet.php?subfolder=&doc="+filename_doc+"&stuid="+uid+"&testid="+mySplitResult[0]+"&totaldoc="+mySplitResult[4];
									//alert(url);
		...
		?>
				...
				<tr>
					...
					<?php
												...
												$subname=$row_c1[0];
												echo "<label style='float:left;color:#ffffff;padding-left:5px;'><font face='verdana' size='2' color='white' ><b>Welcome &nbsp;&nbsp;&nbsp;".$u5."&nbsp;&nbsp;!&nbsp;&nbsp;&nbsp;&nbsp;".$tutorname.">".$crname.">".$subname.">"."Upload Answersheet<b></font></label>";
								...
								<td style='width:100%;'>
									...
									<label>No of Pages</label>&nbsp;<input type="text" id="total_page" style="width:60px;" name="total_page"/>	
										...
										<input type='submit' id='submit2' name='submit2' class='defaultbutton' value = 'Upload Answersheet'/>&nbsp;
												<input type='BUTTON' id='submit' name='submit' class='defaultbutton' value = 'View My Paper'/>&nbsp;&nbsp;&nbsp;
