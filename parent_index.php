...
<!-- this is subjective paper test anchor tag -->
			...
			$('#sch_online_test_regular').click(function()
			{
				...
				var url = "http://111.118.187.38/ADMENECAS/UserLogin.aspx?ClientID=29200";
	...
	<table style="width:1270px;">
		<tr>
							...
							<tr>
								...
								<td>
									<div id="additional_topic_cover">
										...
										<input type="button" id="add_topic" class="classname" value="Add" class="defaultbutton"/>
									</div>
								</td>
							</tr>
						</table>
												...
												<table style="width: 10px;height: 110px; background-color:#FFFFFF;border:1px solid blue;">
													...
													<tr style="height:100%;">
														<td >
															...
															<input type="button" id="OMR_online_answer_submit" name="OMR_online_answer_submit" style="color:red" value="Final Submit" class="defaultbutton" />
															<input type="button" id="OMR_online_View_Result" name="OMR_online_View_Result" value="View Result" class="defaultbutton" />
														</td>
													</tr>
												</table>
											</div>
			...
			<div id="plan" style="position:absolute;top:60px;">
				<table>
					<tr>
						<td><div class='demo'>
							<table border='1'>
