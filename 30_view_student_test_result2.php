<?php
		...
		WHERE alt.student_id='$uid' AND alt.test_id=atr.test_id AND standard_id='$std_result' AND alt.chapter_id=c.id AND SUBJECT='$sb_result' AND sd.user_id=alt.student_id
			...
			while($row2=mysql_fetch_array($result2))
			{
				...
				if($j%2 == 0)
				{
					...
					echo "<td style='width:100px;border:solid 0px;height:20px;'><center><label style='color:black'><b>".$row[1]."</b></label></center></td>";
						...
						//end checking
						//echo "<td style='font-size:13px;width:55px;height:30px;border-width: 2px; border-style: solid; border-color: GREEN;'><b><input type='button' class='defaultbutton' id='view_result1' value='View Report' /></b></td>";
					echo "</tr>";
					$j++;
				}
				else if($j%2 == 1)
...
<div id="login_form_dg">
	...
	<form action="" style="width:100%;">
		...
		<table style="border:1px solid;width:100%;">
			<div id="documentViewer2" class="flexpaper_viewer" style="border:solid 1px;width:680px;height:360px"></div>
