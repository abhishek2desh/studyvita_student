...
{	
	...
	$.ajax({
		...
		var page_source="view_my_result_subjective.php";
				...
				if(medium=="English" || medium=="english")
				 {
					...
					var mySplitResult = bal.split(",");
						...
						filename = "query/view_video_topic_sub.php?sid="+stid+"&test_id="+tt_id+"&uid="+uid;
						
						getContent(filename, "videos");
							filename = "query/view_ppt_topic_sub.php?sid="+stid+"&test_id="+tt_id+"&uid="+uid;
						//alert(filename);
						getContent(filename, "ppt");
												filename = "query/view_note_topic_sub.php?sid="+stid+"&test_id="+tt_id+"&uid="+uid;
					
						getContent(filename, "notes");
						doc_id=stid+sname+tt_id;
						//alert(doc_id);
						filename = "test_paper_generator/view_concept_google_sub.php?subject_id="+sbjt12+"&sid="+stid+"&test_id="+tt_id;
						//alert(filename);
						getContent(filename, "concept_id");
						$("#int_1").show();
						filename = "ppt1_subjective.php?sid="+stid+"&test_id="+tt_id;
						//alert(filename);
						getContent_dig(filename, "dig_rep_id1");
						$("#virtual_id").html("");
						filename = "query/get-virtual-class-schedule-sub.php?sub_id="+sub_id+"&batch_id="+batch_id+"&uid="+uid+"&test_id="+tt_id;
						//alert(filename);
				getContent(filename, "virtual_id");
			 filename = "query/get-facultylist.php?sub_id="+sub_id+"&course_id="+course_id+"&test_id="+tt_id;
					//alert(filename);
...
//alert(filename);
			...
			$("#shadow").fadeIn("normal");
				...
				sb12=sub_name_rs;
				sb11=""
				filename = "30_view_student_test_result_sub.php?uid="+uid+"&sb_result="+sb11+"&cp_result="+cp_result+"&std_result="+std_result;
			//alert(filename);
						...
						<div style="background-color:#3366FF;border:solid 0px;width:100%;height:40px;">
							<table style='width:100%'>
								<tr>
									...
									<td style="width:100px;background-color:#3366FF;border:solid 1px;height:20px;"><center><label style="color:white"><b>Obtained Marks</b></label></center></td>
									<td style="width:100px;background-color:#3366FF;border:solid 1px;height:20px;"><center><label style="color:white"><b>Total Marks</b></label></center></td>
