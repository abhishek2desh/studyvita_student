...
<div style='border:solid 0px;padding-left:0px;' class="link-container">
                ...
                <br/><blink><center><font color="yellow" size="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Select Course</font></center></blink>
                <div class="row">
...
<!--                                        <center>-->
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div id="course_id" style="height:150px;overflow-y:scroll;width:60%;">
                                                <div class="col-md-12">
                                                    <?php
...
$result_st=mysql_query("SELECT faculty_as_student FROM `user` WHERE id='$s5'  ");
  ...
  <div class="col-md-12" style="padding-top:30px;">
                                    ...
                                    <div class="col-md-12">
                                        <div id="course_id_resource" style="height:100px;overflow-y:scroll;padding-top:0px;width:60%;">
                                                <div class="col-md-12">
												<?php
												  $result = mysql_query("SELECT DISTINCT c.id,c.name,c.tutor_id,u.name,str.expire_date,DATE_FORMAT(str.expire_date,'%d-%m-%Y') 
